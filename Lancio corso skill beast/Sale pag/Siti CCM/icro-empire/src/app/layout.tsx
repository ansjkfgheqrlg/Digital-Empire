...
export const metadata: Metadata = {
  ...
  description:
    "Il framework in 4 step che trasforma Claude Code nel tuo collaboratore perfetto. 12 pagine, 1 template pronto. Gratis.",
  robots: { index: false, follow: false },
  openGraph: {
    title: "Claude Code Mastery | Il Framework I.C.R.O.",
    description:
      "Il metodo in 1 pagina che trasforma Claude Code nel tuo collaboratore perfetto. Scaricalo gratis.",
    type: "website",
    locale: "it_IT",
  },
};
