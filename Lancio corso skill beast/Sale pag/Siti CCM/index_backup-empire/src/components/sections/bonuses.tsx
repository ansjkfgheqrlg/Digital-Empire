...
const ecosystem = [
  {
    ...
    desc: "9 Moduli (6 core + 3 avanzati: Claude Code Avanzato, Cowork Avanzato, Ricerca di Mercato). 30+ video-lezioni ed esercizi pratici, 14+ ore di documentazione tecnica ad alta densità.",
  },
  {
    n: "02",
        ...
        <div className="text-center mb-16">
          ...
          <Reveal delay={0.1}>
            <h2 className="text-[36px] md:text-[52px] font-bold leading-tight mb-8 mt-6">
              <span className="text-silver-black">Ecco l'</span>
              <span className="text-orange-pure italic font-medium">ecosistema</span>
              <br />
              <span className="text-silver-black">che ricevi </span>
              <span className="text-orange-pure italic font-medium">subito</span>
            </h2>
          </Reveal>
        </div>
