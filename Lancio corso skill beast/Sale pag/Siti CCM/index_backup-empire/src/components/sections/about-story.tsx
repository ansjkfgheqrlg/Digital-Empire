    ...
    <>
      ...
      <section className="bg-paper section section-border-t relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 text-center relative">
          ...
          <Reveal delay={0.1}>
            <p className="text-ink/45 text-[11px] uppercase tracking-[0.32em] font-black mb-6">
              → Adesso che hai visto cosa costruisco, ti racconto da dove vengo
            </p>
          </Reveal>
      ...
      <section className="bg-ink section section-border-t relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 relative">
          <Reveal>
            <span className="bubble-orange mb-8">La mia storia · in prima persona</span>
          </Reveal>
          ...
          <div className="space-y-7 text-white/80 text-[17px] leading-[1.7] font-medium">
            <Reveal delay={0.2}>
              <p>
                ...
                in questo mondo da curioso, ho avuto la mia fase &ldquo;ogni business è il mio preferito&rdquo;:
              ...
              >
                <p className="text-[18px] md:text-[20px] leading-relaxed text-white">
                  ...
                  <strong className="text-orange-pure">
                    usare l&apos;intelligenza artificiale per usare l&apos;intelligenza artificiale.
                  </strong>{" "}
                  Una chat che mi guida a costruire un GPT. Un&apos;altra che mi crea i file di conoscenza.
                  Un&apos;altra che mette tutto in ordine. Ricorsione. Architettura. Sistema.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.4}>
              <p>
                ...
                <span className="text-silver-orange">System AI completi</span> che oggi fanno ricerche, scrivono copy,
                costruiscono siti, gestiscono clienti — al posto mio.
              </p>
            </Reveal>
      ...
      <section className="bg-grey section section-border-t relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative">
          ...
          <Reveal delay={0.4}>
            <p className="mt-10 text-[12px] uppercase tracking-[0.3em] font-black text-ink/55">
      ...
      <section className="bg-ink-2 section section-border-t relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <Reveal delay={0.2}>
              <p className="text-white/65 text-[16px] max-w-2xl mx-auto mt-6 leading-relaxed">
            ...
            <Reveal delay={0.25}>
              ...
              >
                ...
                <p className="text-white/75 text-[14.5px] leading-relaxed">
                  Sei anni di marketing. Tre di AI a tempo pieno. È la testa dietro ogni System AI che spediamo —
            ...
            <Reveal delay={0.45}>
              ...
              >
                ...
                <p className="text-white/75 text-[14.5px] leading-relaxed">
                  ...
                  decide cosa spediamo e come. Quando entri in Empire, anche lui è uno di quelli con cui ti troverai a
                  costruire.
                </p>
              </div>
            </Reveal>
          ...
          <Reveal delay={0.55}>
            <p className="text-center text-white/55 text-sm max-w-2xl mx-auto mt-14 leading-relaxed">
      ...
      {/* ────────────────────────────────────────────────────────── */}
      {/* 5 · COSA FACCIAMO + MISSIONE — paper                        */}
      {/* ────────────────────────────────────────────────────────── */}
      <section className="bg-paper section section-border-t relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 relative">
          <div className="text-center mb-14">
            ...
            <Reveal delay={0.1}>
              <h2
                ...
                style={{ letterSpacing: "-0.025em" }}
              >
                <span className="text-silver-black">Costruiamo System AI che </span>
                <span
                  className="text-orange-pure"
                  style={{
                    fontFamily: "var(--font-serif), Georgia, serif",
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-16">
            {[
              {
                t: "System AI per Brand & Agenzie",
                d: "Architetture complete: ricerca, copy, content, lead-gen automatizzati. Spediamo il sistema, ti passiamo le chiavi.",
              },
              {
                t: "Skill, Agenti & Workflow su misura",
                d: "Costruiamo per te ciò che internamente useresti mesi a capire. Pronto, testato, integrato nel tuo stack.",
              },
              {
                t: "Formazione Builder — Claude Code Mastery",
                d: "Il percorso che hai appena visto. Trasferiamo lo stesso metodo che usiamo sui clienti, a chi vuole impararlo davvero.",
              },
            ].map((s, i) => (
              <Reveal key={i} delay={0.2 + i * 0.1}>
                ...
                >
                  ...
                  <p className="text-[14px] text-ink/70 leading-relaxed">{s.d}</p>
                </div>
              </Reveal>
            ))}
          </div>
          ...
          <Reveal delay={0.5}>
            ...
            >
              <div className="text-[10px] uppercase tracking-[0.3em] font-black text-ink/55 mb-5">
                La nostra missione
              </div>
              <p
              ...
              <p className="mt-6 text-ink/65 text-[15px] leading-relaxed max-w-xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative">
          ...
          <Reveal delay={0.2}>
            <p className="text-ink/75 text-[17px] md:text-[19px] leading-[1.6] max-w-xl mx-auto mb-12 text-balance">
              C&apos;è una porta sola. <strong className="text-orange-pure">Scegli di attraversarla oggi.</strong>
            </p>
          </Reveal>

          <Reveal delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-3 items-center justify-center">
              <a href="https://buy.stripe.com/aFafZj9bU0J25sj9MDdby00" className="btn-orange inline-flex">
                Inizia da Claude Code Mastery
          ...
          <Reveal delay={0.4}>
            <p className="mt-8 text-[12px] uppercase tracking-[0.28em] font-black text-ink/45">
              → Il primo passo dentro il sistema che usiamo ogni giorno.
            </p>
          </Reveal>
        </div>
      </section>
