...
export const ObjectionCPB_Website: React.FC = () => {
    return (
        <section id="objection-website" className="py-32 relative overflow-hidden bg-[#DCD8CF]">
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                <div className="mb-20">
                    ...
                    <h2 className="font-serif text-4xl md:text-6xl text-slate-900 font-black leading-tight lowercase">
                        "ho già un <span className="italic text-slate-500">sito web</span> online..."
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                un sito 'vetrina' è un costo invisibile che regala leads.
                            </h3>
                            <p className="text-slate-700 text-sm leading-relaxed font-medium mt-10">
                                Avere un sito statico nel 2026 equivale a non averlo. Se non converte visitatori in clienti attivi, stai letteralmente sprecando traffico (e soldi).
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                incrementi misurabili fino al +400%.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                I nostri ecosistemi di conversione registrano costantemente performance superiori rispetto ai siti tradizionali a parità di spesa pubblicitaria.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                trasforma il traffico in asset di profitto.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                Trasformiamo il tuo sito in un asset che genera profitto 24/7, permettendoti di scalare il business senza dover aumentare il budget pubblicitario.
                            </p>
                        </div>
