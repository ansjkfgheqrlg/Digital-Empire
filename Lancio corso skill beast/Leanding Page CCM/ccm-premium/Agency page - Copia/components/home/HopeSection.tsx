...
export const HopeSection: React.FC = () => {
  ...
  const silverGoldGradient = {
    backgroundImage: 'linear-gradient(180deg, #FFFFFF 0%, #E2E8F0 30%, #FDE68A 50%, #D4AF37 70%, #B45309 100%)',
    WebkitBackgroundClip: 'text',
    backgroundClip: 'text',
    WebkitTextFillColor: 'transparent',
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16">
          ...
          <div className="text-center md:text-left">
            <MotionDiv
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-playfair text-3xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] mb-6 lowercase">
                <span style={silverGradient as any}>la speranza non è una </span>
                <span style={silverGoldGradient as any} className="underline decoration-gold-500/30 underline-offset-8">strategia aziendale</span>.
              </h2>
