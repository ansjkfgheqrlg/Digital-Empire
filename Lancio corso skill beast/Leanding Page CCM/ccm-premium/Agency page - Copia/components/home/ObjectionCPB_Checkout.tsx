...
import { ShoppingCart, BarChart3, TrendingUp, ArrowRight } from 'lucide-react';

const MotionDiv = motion.div as any;

export const ObjectionCPB_Checkout: React.FC = () => {
    return (
        <section id="objection-checkout" className="py-32 relative overflow-hidden bg-[#DCD8CF]">
            {/* Background Container with Textures */}
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                <div className="mb-20">
                    ...
                    <h2 className="font-serif text-4xl md:text-6xl text-slate-900 font-black leading-tight lowercase">
                        "se mando subito al <span className="italic text-slate-500">checkout</span> il cliente acquista subito..."
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                il traffico freddo non compra, rifiuta il rischio.
                            </h3>
                            <p className="text-slate-700 text-sm leading-relaxed font-medium mt-10">
                                Mandare un utente che non ti conosce direttamente alla cassa è come chiedere di sposarti al primo appuntamento. Senza fiducia, l'attrito è insormontabile e il tuo budget pubblicitario viene bruciato in rimbalzi immediati.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                +600% di efficienza con il ponte educativo.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                I test split A/B dimostrano che un percorso che educa prima di vendere (Protocollo Ponte) converte dal 3% all'8%, contro lo scarso 0.5% della vendita diretta. Stai lasciando il 90% del potenziale sul tavolo.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                scala il business con roi matematico.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                Eliminando l'attrito iniziale, ogni euro investito in ads genera un ritorno multiplo e costante. Non rincorri più il singolo acquisto casuale, ma costruisci un flusso di cassa solido e totalmente prevedibile.
                            </p>
                        </div>
