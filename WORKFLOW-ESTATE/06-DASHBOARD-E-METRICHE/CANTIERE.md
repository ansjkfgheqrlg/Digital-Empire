...
- **Owner:** Gael
- **Avanzamento:** task board: 1/7 fatti
- **Entrypoint:** `YOUTUBE-AUTOMATION-FACTORY/02-AUTOMAZIONI-E-SCRIPTS` — presente
- **Prossimo task board:** TASK-YT-002 — YT-Factory: F4 Produzione, spec Fliki reale multi-scena da script.md di F3 (owner Gael)
- **Prossimo passo:** TASK-YT-002 (F4 Produzione): spec Fliki reale multi-scena da script.md di F3. Gate: 2 run diverse -> produzione-spec.json con scene_count/testo diversi.
