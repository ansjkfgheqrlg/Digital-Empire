...
- **Gael:** Creato script esecutivo in Python (`yt_ingester_tool.py`) basato su `yt-dlp` per estrarre metadati e sottotitoli di YouTube, dando funzionalità reale al workflow di `video-ingestion` anti-copyright.
