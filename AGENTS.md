# AGENTS.md — Digital Empire Knowledge Engine

## REGOLA ZERO: MEMORY-FIRST (ecosistema 10 MEMORY — ADR-002)

**PRIMA di qualsiasi task** in questa directory:
1. Leggi `company/Memory/INDEX.md` + `company/Memory/STATO-EMPIRE.md` (stato corrente, decisioni attive, RIPRESA DA).
...
Ad ogni conversazione in questa directory, Codex DEVE:
...
- **Info Products** — corsi, ebook, comunità (Manuale Codex, Vendi la Skill)
