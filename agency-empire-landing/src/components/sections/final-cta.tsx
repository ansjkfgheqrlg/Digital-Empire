        ...
        <div className="grid md:grid-cols-2 gap-6 mb-20 text-left">
          <Reveal delay={0.1}>
            <div className="card-dark ring-1 ring-white/5 p-8 h-full flex flex-col">
              <span className="text-xs font-bold uppercase tracking-widest text-white/60 mb-4 block">Opzione A · Lo status quo</span>
              <h3 className="text-2xl font-bold text-white/75 mb-4">Continui come prima</h3>
          ...
          <Reveal delay={0.4}>
            <div className="flex flex-col gap-6 items-center">
              <div className="flex flex-col sm:flex-row gap-3 items-center justify-center">
                <CallCTA variant="dark" className="scale-110" label="Prendiamoci 30 minuti" sublabel="Gratuita · Zero impegno · Nessun follow-up insistente" />
              </div>
