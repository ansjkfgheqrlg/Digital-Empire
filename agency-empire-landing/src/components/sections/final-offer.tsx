...
import { Check, Sparkles, Zap, Bot, Cpu, Workflow, Terminal } from "lucide-react";
          ...
          >
            ...
            <Reveal delay={0.1}>
              <div className="flex flex-col items-center text-center mb-10">
                ...
                <div className="text-[11px] uppercase tracking-[0.28em] font-black text-ink/70 mb-3">
                  Digital Empire · Implementazione AI
                </div>
                <p className="text-ink/85 text-[17px] md:text-[19px] max-w-xl leading-relaxed font-medium">
                  Installa il tuo{" "}
                  <strong className="text-ink">sistema AI proprietario</strong> e fai girare l'operatività
            ...
            <Reveal delay={0.2}>
              ...
              >
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-[0.3em] font-black text-orange-pure">
                  v1.0 · Digital Empire
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
              ...
              <Reveal delay={0.4}>
                ...
                >
                  <div className="text-[11px] uppercase tracking-[0.24em] font-black text-white/75 mb-3">
                    Investimento
                  </div>
                  <div
