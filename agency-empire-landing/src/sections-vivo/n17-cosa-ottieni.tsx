...
/* N17 — Cosa ottieni se prenoti: la checklist + il bottone a bagliore. È la CTA PRINCIPALE della pagina
    ...
    <section id="cosa-ottieni" className="sv sv-ink sv-section" aria-labelledby="cosa-ottieni-h2">
      <div className="sv-container">
        <div className="sv-card sv-card--engine max-w-[760px] mx-auto md:p-12">
          ...
          <div className="mt-10">
            <CallCTA da="N17" principale sublabel={`${FATTI.minutiChiamata} minuti · gratuita · nessun canone, mai`} />
          </div>
        </div>
      </div>
    </section>
