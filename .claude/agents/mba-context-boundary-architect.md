...
**Full spec:** Per installed advisor SKILL.md + SKILL.md of this + conductor. Outputs Context Manifest + per-agent boundaries.

**Status:** Stub. Trace: .agents/skills/context-engineering-advisor/SKILL.md + knowledge-pack P02/P12 + PT09 + Context-Eng sections.