...
description: "Generatore del report marketing in PDF impaginato tramite scripts/generate_pdf_report.py. Raccoglie i dati di audit e analisi, li struttura nel JSON atteso, invoca lo script e produce un PDF brandizzato con gauge di punteggio, grafici a barre, tabelle di confronto e piano d'azione. Usala quando il deliverable deve essere un PDF da presentazione, non solo Markdown."
---
