---
name: market-audit
description: "Orchestratore dell'audit marketing completo per il comando /market audit. Lancia 5 subagent in parallelo, aggrega i risultati e produce MARKETING-AUDIT.md, un report con punteggi, prioritizzato e revenue-focused, pronto per il cliente. Comando di punta della suite marketing. Usala quando l'utente chiede un audit marketing completo di un sito."
---
