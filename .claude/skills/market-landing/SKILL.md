---
name: market-landing
description: "Analisi CRO completa di una landing page. Produce un teardown sezione per sezione con fix prioritizzati che impattano direttamente il tasso di conversione. Usala quando l'utente passa l'URL di una landing e chiede review, audit o ottimizzazione della conversione."
---
...
| Creator / Bio-Link Landing | Far capire chi sei e come ingaggiarti (contatto o pagamento diretto) | n/d | n/d |

### Step 2: Run the 7-Point CRO Framework

**Nota sul tipo "Creator / Bio-Link Landing".** Riceve traffico organico da bio-link social, non traffico a intento. La sua struttura minima e' 5 blocchi — chi sei, cosa fai, per chi, modulo di contatto, (opzionale) pagamento diretto — quindi **i pesi del framework a 7 punti vanno riequilibrati**: value proposition e CTA restano centrali, mentre social proof e objection handling possono legittimamente essere assenti senza che questo sia un difetto. Errore di audit da evitare: penalizzare una pagina di questo tipo per "manca la sezione testimonianze" quando il suo compito e' far capire chi sei e come pagarti, non convincere. Nessun benchmark di conversion rate disponibile da questa fonte: non inventarne. *(Fonte: Andrei Pascu, video "L'importanza di avere una buona landing" `-a0uuA1lbSI`, 2026-09-01 - caso singolo, non validato su altre fonti.)*
