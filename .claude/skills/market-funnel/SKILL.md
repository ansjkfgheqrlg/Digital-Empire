---
name: market-funnel
description: "Motore di analisi funnel per il comando /market funnel. Mappa il percorso di conversione dalla prima visita all'acquisto, individua i punti di abbandono, quantifica la frizione e propone ottimizzazioni prioritizzate con stima di impatto sul fatturato. Usala quando serve capire dove il funnel perde soldi."
---
...
| **Opt-in balance** | 0-10 | E' proporzionato? (10 = campi richiesti in equilibrio col valore percepito del magnet, non semplicemente pochi) |
| **Opt-in copy** | 0-10 | La pagina di opt-in e' scritta come una sales page (beneficio, preview, obiezioni) o e' un form nudo dato per scontato? |
...
**Nota di lettura del ranking:** l'ordine misura la conversione media, non la qualita' assoluta del singolo magnet. Il criterio che decide davvero e' se il magnet chiude un ciclo di fiducia dimostrata - dare una soluzione reale e far percepire un progresso concreto prima di chiedere l'acquisto. Un formato "alto" in classifica ma vuoto converte peggio di un formato "basso" che risolve davvero un problema. Corollario: un quiz e' tra i formati piu' deboli su questo asse (interazione senza soluzione consegnata), utile soprattutto quando l'argomento e' grande e serve abbassare la soglia d'ingresso. *(Fonte: Andrei Pascu, video "Usa questi 10 lead magnet" `j4UInmM9kKA`, 2026-09-01 - caso singolo, non validato su altre fonti.)*
