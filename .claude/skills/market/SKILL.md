---
name: market
description: "Orchestratore della AI Marketing Suite per Digital Empire. Instrada tutti i comandi /market (audit, quick, copy, emails, social, ads, seo, funnel, landing, brand, competitors, launch, proposal, report) verso la sub-skill giusta e produce deliverable client-ready da riga di comando. Usala quando l'utente scrive /market, chiede una analisi marketing completa di un sito, o non sa quale comando marketing gli serve."
---
