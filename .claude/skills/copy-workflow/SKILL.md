---
name: copy-workflow
description: "Orchestration layer multi-agente per la produzione di copy persuasivo professionale basato sul framework APSOC (Attenzione, Problema, Promessa, Social Proof, Obiezioni, CTA). Coordina ricerca, scrittura, critica e rifinitura in un unico flusso. Usala quando serve copy di livello agenzia end-to-end e non un singolo pezzo isolato."
---
