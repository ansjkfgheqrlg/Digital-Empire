# CANTIERI — l'anello di ritorno della Fabbrica (§10)

Ogni sito costruito lascia `cantieri/<nome>/LEZIONE.md` e una riga qui. Una soluzione che ha funzionato in
due cantieri diventa pattern; un errore accaduto due volte diventa controllo del gate.
