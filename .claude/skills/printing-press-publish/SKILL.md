...
description: "Publish a generated CLI to the printing-press-library repo so other machines and sessions can install it. Use it after a CLI has been generated, polished and scored, when the user asks to publish, ship or share a printing-press CLI."
version: 0.1.0
