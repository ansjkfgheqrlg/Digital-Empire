...
**PAT used:** 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 (read confirmed via API; write 403 scope limit — setup git remote with token for user push)
