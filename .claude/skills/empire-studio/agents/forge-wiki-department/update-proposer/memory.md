# update-proposer - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **updates/**: proposte generate
- **checkpoints/**: update-proposer eseguito per run X
...
## Trace (P12)
risponde a 'la wiki viene interrogata su come aggiornare i flussi esistenti'.
