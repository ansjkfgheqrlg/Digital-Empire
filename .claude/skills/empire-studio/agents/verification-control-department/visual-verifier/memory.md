# visual-verifier - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **verification-logs/**: esiti verifica visione
- **bugs/**: allucinazioni rilevate
...
## Trace (P12)
controlla che 'il video sia stato davvero visto' (anti watcher-finto).
