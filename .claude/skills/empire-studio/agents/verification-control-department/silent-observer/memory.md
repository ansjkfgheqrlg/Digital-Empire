# silent-observer - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **verification-logs/**: osservazioni
- **updates/**: proposte di miglioramento
- **agent-state/**: segnali raccolti
...
## Trace (P12)
PT07 silent observer; risponde a 'verificare che tutto stia andando bene'.
