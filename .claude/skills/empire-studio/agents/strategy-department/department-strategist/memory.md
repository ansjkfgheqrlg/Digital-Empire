# department-strategist - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **strategy-applications/**: raccomandazioni di reparto
- **checkpoints/**: consulenza fornita
...
## Trace (P12)
risponde a 'strategie per reparto YouTube/TikTok/Web'.
