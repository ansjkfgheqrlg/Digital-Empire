...
## Strumenti che usa
1. **transcript-clean-skill** - parsing e pulizia vtt
   ```
   (logica eseguita dall'agente; helper in skills/tier2-functional/transcript-clean-skill)
   ```
