# Orchestration Layer Architect v2.1 — Piano di produzione APEX-7 · Livello 3
...
**Piano genitore:** [`PIANO_PRODUZIONE_Orchestration_Layer_v2.1_APEX7_L2.md`](PIANO_PRODUZIONE_Orchestration_Layer_v2.1_APEX7_L2.md)  
**Livello:** **L3/7 — scope contract, classi di rischio e readiness circoscritta**  
**Regola di versione:** questo file eredita integralmente L2 e introduce un solo miglioramento tematico addizionale.
...
- release manifest firmato con `scope_id`, `scope_hash` ed evidence bundle;
