# Orchestration Layer Architect v2.1 — Piano di produzione APEX-7 · Livello 6
...
**Piano genitore:** [`PIANO_PRODUZIONE_Orchestration_Layer_v2.1_APEX7_L5.md`](PIANO_PRODUZIONE_Orchestration_Layer_v2.1_APEX7_L5.md)  
**Livello:** **L6/7 — integrità della catena di trust, identità e autorità**  
**Regola di versione:** questo file eredita integralmente L5 e introduce un solo miglioramento tematico addizionale.
...
|---|---|---|---|
| **G1 Foundation** | threat model, glossary, ADR, ownership, authority/principal contracts, schemas, SLO workload, 43 finding tracciati | Tech Lead + Security + Data | F0 |
...
| **G7 Production** | trust-chain verificata, canary, backup/restore, rollback, revocation, on-call, audit, no blocker, signed manifest | Accountable Executive/Product + Tech + Security + SRE | fase responsabile o rollback |
