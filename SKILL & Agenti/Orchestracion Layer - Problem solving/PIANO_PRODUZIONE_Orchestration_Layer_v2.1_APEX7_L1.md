# Orchestration Layer Architect v2.1 — Piano di produzione APEX-7 · Livello 1
...
**Piano genitore:** [`PIANO_PRODUZIONE_Orchestration_Layer_v2.1_APEX7.md`](PIANO_PRODUZIONE_Orchestration_Layer_v2.1_APEX7.md)  
**Livello:** **L1/7 — calibrazione di realismo, capacità e data credibile**  
**Regola di versione:** questo file eredita integralmente il piano genitore e introduce un solo miglioramento tematico.
...
La stima L1 sostituisce la precedente previsione di 20–24 settimane. Per il full scope G1–G7, la range prudente è **39–53 settimane con 6–8 FTE nominali e focus medio 0,70**, oppure **56–76 settimane con 4–6 FTE nominali**. Nessuna data è impegnabile prima della chiusura degli input F0 elencati nel calcolatore di realismo. Tech lead/runtime, backend, platform/SRE, security, QA/eval e product/domain ownership devono essere coperti esplicitamente; una persona può coprire più ruoli, ma non crea capacità aggiuntiva.
