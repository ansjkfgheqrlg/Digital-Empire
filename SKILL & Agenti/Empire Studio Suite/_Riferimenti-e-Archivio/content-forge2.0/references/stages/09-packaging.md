...
```
<workspace>/forge-run-<ts>/stage-09/packaged/
...
Quando Stage 8 conclude con PASS o WARN (mai con FAIL).
...
L'artefatto è presente in `stage-09/packaged/` ed è leggibile/installabile.
