# Concetti — target-avatar

> Concetti chiave applicati da target-avatar dentro il workflow preventivi.

## Cosa è questa skill

target-avatar è un componente specializzato del workflow preventivi-workflow. Non opera isolato — riceve input da altri componenti e produce output strutturato.
