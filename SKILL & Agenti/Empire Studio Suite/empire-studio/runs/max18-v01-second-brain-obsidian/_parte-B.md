> **Nota**: file prodotto dalla Sentinella "blocco B" — scene 146→250 (105 scene) di `RnoC5IlOUhs`, run `max18-v01-second-brain-obsidian`. Da fondere in `video-analysis.md` (non toccato qui). Frame da `frames-hd/` (1280x720). Convenzioni identiche al file principale: `➕` = inferenza non letta/sentita; citazioni da `transcript.md` integrale.

---

# PARTE B1 — Tassonomia ed Ontologia nell'AI [continua] (63:12 → 64:12)
