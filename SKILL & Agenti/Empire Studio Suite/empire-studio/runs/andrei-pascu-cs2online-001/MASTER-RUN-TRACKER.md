...
| AI – per coding e simili | 7 (L17-L23) | 0 | 7 |
...
**RIPRESA DA:** Lezione 10 — "Cliente manda audio Claude fa revisioni" (`lezione-10-cliente-manda-audio-claude-fa-revisioni-zgc9x`), prima lezione sezione "AI – per produttività e freelance" (10-12) — unica sezione rimasta con pending prima di "AI – per coding" (17-23) e "CS2" (avanzata). — "Automatizzare processi" (`bonus-1-automatizzare-processi-xcrw8`). Sezione "AI - per copywriting" (13-16) COMPLETA (14-15 restano pending/saltate).
...
| # | Titolo | Slug URL | Tipo | Status |
|---|---|---|---|---|
| 17 | Introduzione al vibe coding | `lezione-17-introduzione-al-vibe-coding-3bgtt` | TEORIA (intro) | pending |
