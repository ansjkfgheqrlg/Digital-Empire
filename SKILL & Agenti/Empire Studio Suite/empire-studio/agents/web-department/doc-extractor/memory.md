# doc-extractor - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **checkpoints/**: contenuto web estratto
- **knowledge-state/**: testo web pulito con trace
...
## Trace (P12)
prepara il materiale web per il forge, con tracciabilita' a URL.
