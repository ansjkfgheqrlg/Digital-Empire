# meta-strategy-manager - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **strategy-versions/**: registry versionato
- **decisions/**: ADR sulle strategie
- **checkpoints/**: registry aggiornato
...
## Trace (P12)
gestisce la libreria di 'tante strategie' (meta-livello).
