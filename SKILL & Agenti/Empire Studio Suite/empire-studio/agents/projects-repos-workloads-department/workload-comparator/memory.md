# workload-comparator - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **updates/**: proposte cross-workflow
- **workflow-state/**: match progetto vs workflow
...
## Trace (P12)
risponde a 'proporre update ai flussi esistenti' a partire dallo studio di progetti.
