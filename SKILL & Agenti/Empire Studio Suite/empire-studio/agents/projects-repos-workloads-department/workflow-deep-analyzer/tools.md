...
## Strumenti che usa
1. **lettura CLI** - cat/grep/find in sola lettura + analisi dell'agente
   ```
   (l'agente legge i file e scrive deep-analysis.md; nessuna modifica all'originale)
   ```
