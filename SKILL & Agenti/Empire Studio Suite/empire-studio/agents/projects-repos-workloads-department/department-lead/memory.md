...
- **projects-state/**: stato dello studio del progetto
- **repo-analysis/**: esiti analisi repo
...
## Trace (P12)
risponde a 'quarto reparto: progetti, repo, workload... studiarlo nei minimi dettagli... non lo devi modificare'.
