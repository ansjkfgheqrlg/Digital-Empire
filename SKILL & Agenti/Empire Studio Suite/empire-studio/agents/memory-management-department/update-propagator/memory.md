# update-propagator - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **updates/**: le propagazioni
- **workflow-state/**: coerenza
- **knowledge-state/**: coerenza
...
## Trace (P12)
risponde a 'ogni aggiornamento, tutto deve essere aggiornato'.
