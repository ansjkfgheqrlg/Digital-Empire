...
- **checkpoints/**: supervisione memoria
- **agent-state/**: salute dell'ecosistema di memoria
...
## Trace (P12)
risponde a 'un intero ecosistema di memoria... agenti che gestiscono tutto questo'.
