# tiktok-trend-scout - Memory (P10)

L'agente aggiorna l'ecosistema di memoria dopo OGNI azione significativa.

## Cosa registra e dove
- **strategy-applications/**: criteri trend-scout
- **agent-state/**: qualita' selezione tiktok
...
## Trace (P12)
screening per TikTok analogo a quello YouTube.
