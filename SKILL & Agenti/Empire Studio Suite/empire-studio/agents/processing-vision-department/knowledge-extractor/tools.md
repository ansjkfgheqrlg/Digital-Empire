...
## Strumenti che usa
1. **estrazione atomi** - logica dell'agente (no script): legge analysis+transcript
   ```
   (l'agente Claude assembla atoms.json secondo lo schema in CONVENTIONS)
   ```
