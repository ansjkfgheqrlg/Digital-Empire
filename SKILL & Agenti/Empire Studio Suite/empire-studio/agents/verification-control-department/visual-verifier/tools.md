...
## Strumenti che usa
1. **ispezione frame** - controllo esistenza/size PNG + lettura (Claude) per confronto
   ```
   (il verifier puo' rileggere alcuni frame con Read e confrontarli con le descrizioni)
   ```
