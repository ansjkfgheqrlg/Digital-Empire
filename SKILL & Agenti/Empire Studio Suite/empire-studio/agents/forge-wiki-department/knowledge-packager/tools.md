...
## Strumenti che usa
1. **cli-doc-skill** - formattazione report CLI/docs (cli-printing-press)
   ```
   python skills/tier2-functional/cli-doc-skill/scripts/make_report.py --run <run-id>
   ```
