---
name: cc-master
description: System expert for Codex: creating skills, creating agents, and managing project context.
---
...
- Era in: `C:\Users\Utente\.Codex\plugins\cc-master\`
...
**NOTA:** I capitoli 9-12 (AGENTS.md system, PARTE 3) sono ASSENTI dal file CONOSCIENZA.md originale. Non esistono nel documento sorgente.
...
- `Codex-md-builder.md` — crea/ottimizza AGENTS.md
...
#### STEP 6 — Tutto copiato in .Codex/plugins/cc-master/ ✅
...
```
C:\Users\Utente\.Codex\plugins\cc-master\
├── .Codex-plugin\
│   └── plugin.json              ✅ v2.0
├── agents\
...
### PRIORITÀ ALTA
1. **Testare cc-master v2.0** — aprire nuova sessione Codex e verificare:
...
2. **Aggiungere AGENTS.md globale** — il file `C:\Users\Utente\.Codex\AGENTS.md` non è stato modificato. Potrebbe essere ottimizzato per integrare le regole di cc-master.

### PRIORITÀ MEDIA
3. **Verificare i capitoli 9-12 mancanti** — Il manuale CONOSCIENZA.md non contiene i capitoli 9-12 (PARTE 3 — AGENTS.md system). Potrebbero essere stati omessi nell'originale o essere in un altro file. Se esistono, andrebbero aggiunti.

4. **Creare un AGENTS.md locale per "Agente Max"** — un AGENTS.md nella cartella Agente Max che guidi cc-master quando lavora in quel progetto specifico.
...
- **Doppia posizione:** I file esistono sia in `Agente Max\` (copia di lavoro) che in `.Codex\plugins\cc-master\` (installato). Aggiornare entrambi quando si fanno modifiche.
- **Plugin attivo:** Il plugin è installato e attivo in Codex. Per aggiornarlo, modificare in `Agente Max\` e poi copiare in `.Codex\plugins\cc-master\`.
