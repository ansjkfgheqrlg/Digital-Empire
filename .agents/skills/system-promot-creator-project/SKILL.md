...
# Target: Generazione Completa di Progetti Codex (Custom Instructions + Knowledge Base)
...
> caricato su un assistente Codex o qualsiasi LLM avanzato.**
...
1. Copia `CUSTOM_INSTRUCTIONS.md` nella sezione "System Instructions" del progetto Codex
