...
export const LuxDividerGreenBottom: React.FC = () => {
  return (
    // Bottom Divider: Sits below the Trust section. Creates a downward curve (Bulge).
    <div className="relative w-full h-[100px] md:h-[150px] z-40 pointer-events-none -mt-[2px] flex items-start justify-center">
      
      {/* 1. GRAIN BACKGROUND CONTAINER (CLIPPED TO CURVE) */}
      <div 
        className="absolute inset-0 w-full h-full z-0"
        style={{ clipPath: 'url(#luxGreenBottomClip)' }}
      >
      ...
      >
        <defs>
          {/* 
            Clip Path for the Bulge Shape.
            M 0,0 (Top Left) -> Q 0.5,1 (Bottom Center) -> 1,0 (Top Right) -> Close
          */}
          <clipPath id="luxGreenBottomClip" clipPathUnits="objectBoundingBox">
             <path d="M 0,0 Q 0.5,1 1,0 Z" />
          </clipPath>

          <linearGradient id="luxHighResGradientGreenBottom" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <path 
          d="M -50,0 Q 600,120 1250,0"
          stroke="url(#luxHighResGradientGreenBottom)"
          strokeWidth="3" 
          fill="none"
          strokeLinecap="round"
