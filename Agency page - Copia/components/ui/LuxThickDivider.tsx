...
export const LuxThickDivider: React.FC = () => {
  return (
    // w-screen + negative margins ensures it breaks out of any parent container limits
    <div className="relative w-screen left-1/2 -translate-x-1/2 h-6 z-50 shadow-2xl overflow-hidden">
       {/* Base Metallic Gradient - GOLD DOMINANT with Silver Edges */}
       <div 
