        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 w-full perspective-2000">
            <MotionDiv
              ...
              className="relative overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.8),inset_0_0_30px_rgba(16,185,129,0.05)] border border-emerald-500/30 group rounded-2xl max-w-xl mx-auto"
              style={{
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-emerald-400 to-transparent z-20 opacity-60" />

              <div className="relative z-20 p-6 md:p-10">
                <div className="flex flex-col items-center text-center mb-8">
                  {/* Badge */}
                  <div className="inline-block bg-gradient-to-r from-emerald-900 to-emerald-950 border border-emerald-500/30 text-emerald-400 font-black px-4 py-1.5 rounded-sm text-[10px] uppercase tracking-[0.4em] mb-5 shadow-xl">
                    Invito Esclusivo
                  </div>

                  {/* Title */}
                  <h3 className="font-serif text-2xl md:text-4xl text-white font-black tracking-tighter leading-tight mb-4 drop-shadow-md">
                    SESSIONE STRATEGICA <br /> GRATUITA
                  </h3>

                  {/* Divider */}
                  <div className="w-20 h-[1px] bg-gradient-to-r from-transparent via-emerald-500/50 to-transparent mb-5"></div>

                  {/* Price/Value */}
                  <p className="text-emerald-200/60 font-mono text-[10px] font-bold uppercase tracking-widest">
                ...
                <div className="space-y-3 mb-8">
                  {/* Feature 1 */}
                  <div className="flex items-start gap-4 p-4 bg-black/20 border border-emerald-500/10 rounded-xl backdrop-blur-sm transition-all hover:bg-black/40 hover:border-emerald-500/30 group/item">
                    <div className="w-8 h-8 bg-emerald-950/50 rounded flex items-center justify-center flex-shrink-0 border border-emerald-500/20 group-hover/item:border-emerald-500/50 transition-colors">
                      <Clock className="text-emerald-400 w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="text-white font-black text-[11px] uppercase tracking-wide mb-1">40 Minuti di Consulenza Pura</h4>
                      <p className="text-gray-400 text-[10px] leading-relaxed font-medium">Analizziamo il tuo ecosistema attuale e individuiamo i colli di bottiglia.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-black/20 border border-emerald-500/10 rounded-xl backdrop-blur-sm transition-all hover:bg-black/40 hover:border-emerald-500/30 group/item">
                    ...
                    <div>
                      <h4 className="text-white font-black text-[11px] uppercase tracking-wide mb-1">Garanzia "Zero Rischio"</h4>
                      <p className="text-gray-400 text-[10px] leading-relaxed font-medium">Se senti di aver perso tempo, ti inviamo comunque un piano d'azione in PDF.</p>
                    </div>
                  </div>
                </div>

                {/* Status Bar */}
                <div className="bg-emerald-950/30 p-2.5 rounded-lg mb-6 border border-emerald-500/10 text-center relative overflow-hidden">
                  <div className="flex items-center justify-center gap-2">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
                    </span>
                    <p className="text-emerald-100 text-[9px] font-black uppercase tracking-[0.2em]">
                ...
                {/* CTA Button */}
                <GoldButton fullWidth href="#contact" variant="silverGreen" className="py-4 shadow-[0_0_25px_rgba(5,150,105,0.25)]">
                ...
                {/* Footer Micro-copy */}
                <div className="mt-5 flex flex-col items-center gap-2 opacity-40 hover:opacity-100 transition-opacity">
                  <p className="text-center text-white text-[8px] font-bold uppercase tracking-[0.3em]">
