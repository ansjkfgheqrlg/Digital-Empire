...
import { Users, Radio, Settings2, ArrowRight } from 'lucide-react';

const MotionDiv = motion.div as any;

export const ObjectionCPB_WordOfMouth: React.FC = () => {
    return (
        <section id="objection-word-of-mouth" className="py-32 relative overflow-hidden bg-[#DCD8CF]">
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                <div className="mb-20">
                    ...
                    <h2 className="font-serif text-4xl md:text-6xl text-slate-900 font-black leading-tight lowercase">
                        "il <span className="italic text-slate-500">passaparola</span> mi basta..."
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                il passaparola è un rischio fatale per la crescita.
                            </h3>
                            <p className="text-slate-700 text-sm leading-relaxed font-medium mt-10">
                                Il passaparola è un segnale di qualità, ma è un nemico della scalabilità. Senza un sistema attivo, il tuo fatturato è in ostaggio del caso e della benevolenza altrui.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                rubinetti di traffico vs ostaggio del caso.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                I brand che dominano il mercato non aspettano che qualcuno parli di loro. Hanno sistemi di acquisizione ingegnerizzati che garantiscono flussi di leads costanti.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                dalla speranza alla totale prevedibilità.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                Passerai dall'aspettare clienti al decidere tu quando accelerare o stabilizzare il fatturato. Con un clic, apri o chiudi il flusso in base alla tua capacità produttiva.
                            </p>
                        </div>
