...
import { InclinedMetallicDivider } from '../ui/InclinedMetallicDivider';

const MotionDiv = motion.div as any;

export const ObjectionCPB: React.FC = () => {
    return (
        <section id="objection-specific" className="py-32 relative overflow-hidden bg-[#DCD8CF]">
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                <div className="mb-20">
                    ...
                    <h2 className="font-serif text-4xl md:text-6xl text-slate-900 font-black leading-tight lowercase">
                        "il mio business è <span className="italic text-slate-500">troppo specifico</span>..."
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                la psicologia d'acquisto è universale, non settoriale.
                            </h3>
                            <p className="text-slate-700 text-sm leading-relaxed font-medium mt-10">
                                Non vendiamo a protocolli o a software, vendiamo a persone. Le leve biologiche che spingono un essere umano all'azione sono immutate da millenni.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                estensioni di mercato cross-settoriali.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                Abbiamo applicato questi stessi protocolli in oltre 50 mercati differenti, portando risultati costanti indipendentemente dalla complessità del prodotto.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-slate-900 font-bold mb-4 lowercase">
                                una macchina che forza la conversione.
                            </h3>
                            <p className="text-slate-800 text-sm leading-relaxed font-medium mt-10">
                                Questo significa che non devi 'inventare' nulla: utilizzeremo leve psicologiche infallibili che costringono il tuo cliente target ad agire ora.
                            </p>
                        </div>
