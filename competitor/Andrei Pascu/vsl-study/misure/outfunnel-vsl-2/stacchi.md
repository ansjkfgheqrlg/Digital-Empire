# Stacchi di montaggio - outfunnel-vsl-2

Misura a macchina. Nessuna interpretazione.

| voce | valore |
|---|---|
| durata video | 1:48.82 (108.821 s) |
...
| punteggio di scena mediano (moto dell'immagine) | 0.0026 |
| frame sopra soglia | 2.02% |

Comando: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outfunnel-vsl-2\video.mp4" -an -vf "scale=320:-2,select='gte(scene,0)',metadata=print:file=-" -f null -`

## Sensibilita' alla soglia (stessa passata, soglie diverse)

| soglia | tagli | durata media | mediana | inquadrature < 1 s | |
|---|---|---|---|---|---|
| 0.028 | 64 | 1.67 s | 1.3 s | 23 |  |
| 0.040 | 52 | 2.05 s | 1.44 s | 16 | **usata** |
| 0.055 | 49 | 2.18 s | 1.99 s | 14 |  |
| 0.100 | 47 | 2.27 s | 2.05 s | 13 |  |
...
| 44 | 96.46 | 97.46 | 1.00 |
| 45 | 97.46 | 98.83 | 1.37 |
| 46 | 98.83 | 100.17 | 1.34 |
| 47 | 100.17 | 100.83 | 0.66 |
| 48 | 100.83 | 102.04 | 1.21 |
| 49 | 102.04 | 102.77 | 0.73 |
| 50 | 102.77 | 103.50 | 0.73 |
| 51 | 103.50 | 107.87 | 4.37 |
| 52 | 107.87 | 108.78 | 0.91 |
| 53 | 108.78 | 108.82 | 0.04 |
