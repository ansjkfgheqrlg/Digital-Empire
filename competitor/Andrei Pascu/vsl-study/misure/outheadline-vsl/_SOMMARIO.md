# outheadline-vsl - sommario di misura

Fase 1 di EMP-DIOEDIT. Solo numeri: nessun aggettivo, nessuna interpretazione.
Generato il 2026-09-11 00:16 da `scripts/misura_vsl.py` v1.2.0 in 16.3 s.

## Tecnica

| voce | valore |
|---|---|
| durata | 0:46.25 (46.251 s) |
| risoluzione | 1920x1080 |
| fps reale | 24.0 (dichiarato 24/1) |
| frame totali | 1110 (ffprobe stream=nb_frames) |
| codec video | h264 High, yuv420p |
| bitrate video | 2953831 bps |
| codec audio | aac LC, 48000 Hz, 2 canali |
| bitrate audio | 128836 bps |
| bitrate totale | 3088249 bps |
| peso | 17.0 MB |

Come: `ffprobe -v error -show_format -show_streams -of json "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4"`
...
| durata minima | 0.04 s |
| durata massima | 4.84 s |
| deviazione standard | 1.116 s |
| moto dell'immagine: punteggio di scena p90 | 0.0751 (mediana 0.004, p99 0.5011) |
| frame sopra soglia | 12.43% |
| minuto con piu' tagli | minuto 1, 68 tagli |
| minuto con meno tagli | minuto 1, 68 tagli |

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -an -vf "scale=320:-2,select='gte(scene,0)',metadata=print:file=-" -f null -`
...
| true peak | -0.5 dBFS |
| RMS 0,5 s media / min / max | -19.489 / -26.46 / -12.14 dBFS |
| silenzi assoluti (-40dB, min 0.3 s) | 0, 0 s totali (0.0%) |
| pause a soglia fissa (-30dB, min 0.25 s) | 0, 0 s totali (0.0%) |
| pause a soglia relativa (-31dB = mediana RMS del video (-19.25 dBFS) meno 12 dB, min 0.25 s) | 0, 0 s totali (0.0%) |
| cambi di regime del volume | 1 (soglia 3.0 dB su RMS, 0.0556 su ZCR) |
| picco piu' alto | -0.51 dBFS a 0:09.00 |

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -vn -af ebur128=peak=true:metadata=1,ametadata=print:file=- -f null -`

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -vn -ac 1 -ar 16000 -f s16le -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -vn -af silencedetect=noise=-40dB:d=0.3 -f null -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -vn -af silencedetect=noise=-30dB:d=0.25 -f null -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -vn -af silencedetect=noise=-31dB:d=0.25 -f null -`
...
|---|---|---|---|---|---|
| 0:40.00 | zcr | -0.53 | -19.92 | -20.45 | +0.0556 |

## Frame

| voce | valore |
|---|---|
| frame densi (uno ogni 2.0 s, 960 px) | 23 |
| frame in cui lo schermo cambia | 18 |
| frame sul primo fotogramma di ogni inquadratura | 69 |
| riduzione | 18 su 23 densi (78.3%) |

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -vf fps=1/2,scale=960:-2 -y "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\misure\outheadline-vsl\frames\frame-%04d.png"`

Come: `ffmpeg -v error -nostdin -ss 0.020 -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\outheadline-vsl\video.mp4" -frames:v 1 -vf scale=960:-2 -y "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\misure\outheadline-vsl\frames\stacchi\stacco-0001.png"   (ripetuto per ogni inquadratura)`
