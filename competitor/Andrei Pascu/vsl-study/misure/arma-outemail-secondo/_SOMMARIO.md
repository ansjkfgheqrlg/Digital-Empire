# arma-outemail-secondo - sommario di misura

Fase 1 di EMP-DIOEDIT. Solo numeri: nessun aggettivo, nessuna interpretazione.
Generato il 2026-09-11 00:12 da `scripts/misura_vsl.py` v1.2.0 in 17.2 s.

## Tecnica

| voce | valore |
|---|---|
| durata | 1:46.35 (106.347 s) |
| risoluzione | 1920x1080 |
| fps reale | 29.97003 (dichiarato 30000/1001) |
| frame totali | 3187 (ffprobe stream=nb_frames) |
| codec video | h264 High, yuv420p |
| bitrate video | 3406026 bps |
| codec audio | aac LC, 48000 Hz, 2 canali |
| bitrate audio | 189375 bps |
| bitrate totale | 3604052 bps |
| peso | 45.7 MB |

Come: `ffprobe -v error -show_format -show_streams -of json "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4"`
...
| durata massima | 12.88 s |
| deviazione standard | 2.371 s |
| moto dell'immagine: punteggio di scena p90 | 0.004 (mediana 0.0006, p99 0.1011) |
| frame sopra soglia | 1.76% |
| minuto con piu' tagli | minuto 1, 29 tagli |
| minuto con meno tagli | minuto 2, 16 tagli |

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -an -vf "scale=320:-2,select='gte(scene,0)',metadata=print:file=-" -f null -`
...
| true peak | 0.0 dBFS |
| RMS 0,5 s media / min / max | -24.089 / -34.42 / -9.46 dBFS |
| silenzi assoluti (-40dB, min 0.3 s) | 0, 0 s totali (0.0%) |
| pause a soglia fissa (-30dB, min 0.25 s) | 0, 0 s totali (0.0%) |
| pause a soglia relativa (-36dB = mediana RMS del video (-24.01 dBFS) meno 12 dB, min 0.25 s) | 0, 0 s totali (0.0%) |
| cambi di regime del volume | 2 (soglia 3.51 dB su RMS, 0.05 su ZCR) |
| picco piu' alto | -0.01 dBFS a 0:20.50 |

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -vn -af ebur128=peak=true:metadata=1,ametadata=print:file=- -f null -`

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -vn -ac 1 -ar 16000 -f s16le -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -vn -af silencedetect=noise=-40dB:d=0.3 -f null -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -vn -af silencedetect=noise=-30dB:d=0.25 -f null -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -vn -af silencedetect=noise=-36dB:d=0.25 -f null -`
...
|---|---|---|---|---|---|
| 1:35.00 | rms | -3.51 | -23.65 | -27.16 | +0.0081 |
| 1:40.00 | rms | +7.46 | -27.16 | -19.7 | -0.0017 |

## Frame

| voce | valore |
|---|---|
| frame densi (uno ogni 2.0 s, 960 px) | 53 |
| frame in cui lo schermo cambia | 38 |
| frame sul primo fotogramma di ogni inquadratura | 46 |
| riduzione | 38 su 53 densi (71.7%) |

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -vf fps=1/2,scale=960:-2 -y "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\misure\arma-outemail-secondo\frames\frame-%04d.png"`

Come: `ffmpeg -v error -nostdin -ss 0.020 -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outemail-secondo\video.mp4" -frames:v 1 -vf scale=960:-2 -y "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\misure\arma-outemail-secondo\frames\stacchi\stacco-0001.png"   (ripetuto per ogni inquadratura)`
