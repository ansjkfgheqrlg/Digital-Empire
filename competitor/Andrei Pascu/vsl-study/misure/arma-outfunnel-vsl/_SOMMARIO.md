# arma-outfunnel-vsl - sommario di misura

Fase 1 di EMP-DIOEDIT. Solo numeri: nessun aggettivo, nessuna interpretazione.
Generato il 2026-09-11 00:13 da `scripts/misura_vsl.py` v1.2.0 in 16.7 s.

## Tecnica

| voce | valore |
|---|---|
| durata | 1:39.14 (99.136 s) |
| risoluzione | 1920x1080 |
| fps reale | 29.97003 (dichiarato 30000/1001) |
| frame totali | 2971 (ffprobe stream=nb_frames) |
| codec video | h264 High, yuv420p |
| bitrate video | 4774841 bps |
| codec audio | aac LC, 48000 Hz, 2 canali |
| bitrate audio | 189375 bps |
| bitrate totale | 4972955 bps |
| peso | 58.8 MB |

Come: `ffprobe -v error -show_format -show_streams -of json "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4"`
...
| moto dell'immagine: punteggio di scena p90 | 0.0126 (mediana 0.0027, p99 0.1271) |
| frame sopra soglia | 1.88% |
| minuto con piu' tagli | minuto 1, 24 tagli |
| minuto con meno tagli | minuto 2, 21 tagli |

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -an -vf "scale=320:-2,select='gte(scene,0)',metadata=print:file=-" -f null -`
...
| true peak | -1.3 dBFS |
| RMS 0,5 s media / min / max | -19.174 / -36.67 / -12.9 dBFS |
| silenzi assoluti (-40dB, min 0.3 s) | 0, 0 s totali (0.0%) |
| pause a soglia fissa (-30dB, min 0.25 s) | 1, 0.28 s totali (0.29%) |
| pause a soglia relativa (-31dB = mediana RMS del video (-18.74 dBFS) meno 12 dB, min 0.25 s) | 1, 0.27 s totali (0.27%) |
| cambi di regime del volume | 4 (soglia 3.25 dB su RMS, 0.1051 su ZCR) |
| picco piu' alto | -1.32 dBFS a 0:13.50 |

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -vn -af ebur128=peak=true:metadata=1,ametadata=print:file=- -f null -`

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -vn -ac 1 -ar 16000 -f s16le -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -vn -af silencedetect=noise=-40dB:d=0.3 -f null -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -vn -af silencedetect=noise=-30dB:d=0.25 -f null -`

Come: `ffmpeg -v info -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -vn -af silencedetect=noise=-31dB:d=0.25 -f null -`
...
|---|---|---|---|---|---|
| 0:10.00 | rms | +3.25 | -17.84 | -14.59 | -0.0142 |
| 0:15.00 | zcr | -0.87 | -14.59 | -15.46 | +0.1051 |
| 0:20.00 | zcr | -0.17 | -15.46 | -15.63 | -0.1351 |
| 1:10.00 | rms | -4.55 | -17.29 | -21.84 | +0.0440 |

## Frame

| voce | valore |
|---|---|
| frame densi (uno ogni 2.0 s, 960 px) | 50 |
| frame in cui lo schermo cambia | 47 |
| frame sul primo fotogramma di ogni inquadratura | 46 |
| riduzione | 47 su 50 densi (94.0%) |

Come: `ffmpeg -v error -nostdin -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -vf fps=1/2,scale=960:-2 -y "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\misure\arma-outfunnel-vsl\frames\frame-%04d.png"`

Come: `ffmpeg -v error -nostdin -ss 0.020 -i "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\sorgenti\arma-outfunnel-vsl\video.mp4" -frames:v 1 -vf scale=960:-2 -y "C:\Users\Utente\Desktop\qui tutto\Digital Empire\competitor\Andrei Pascu\vsl-study\misure\arma-outfunnel-vsl\frames\stacchi\stacco-0001.png"   (ripetuto per ogni inquadratura)`
