# Copy integrale — Stripe Claude Speedrun — AP Formazione
**URL:** https://www.andrei-copy.com/stripe-claude-speedrun  ·  **Catturato:** 2026-09-08  ·  **Costruzione:** squarespace
**Altezza:** 1299px  ·  **Blocchi:** 29  ·  **Sezioni:** 1 (1 distinte)
...
**[y=22] `a`** — #fafafa / 14.272px / w500 → `#page`

Passa al contenuto

**[y=30] `div`** — #1b1b1d / 16px / w300

Claude Speedrun

  *in grassetto/link dentro:* Claude Speedrun

**[y=31] `div`** — #fafafa / 16px / w300

Accedi

  *in grassetto/link dentro:* Accedi

**[y=292] `div`** — #a8a8a8 / 24px / w300

Claude Speedrun 2

**[y=359] `div`** — #1b1b1d / 16px / w600

Sign Up

**[y=786] `p`** — #fafafa / 16px / w300

La mia storia

  *in grassetto/link dentro:* La mia storia

**[y=790] `span`** — #fafafa / 16px / w300

La mia storia

**[y=820] `p`** — #fafafa / 16px / w300

Store

  *in grassetto/link dentro:* Store

**[y=824] `span`** — #fafafa / 16px / w300

Store

**[y=855] `p`** — #fafafa / 16px / w300

Recensioni

  *in grassetto/link dentro:* Recensioni

**[y=859] `span`** — #fafafa / 16px / w300

Recensioni

**[y=889] `p`** — #fafafa / 16px / w300

Risorse

  *in grassetto/link dentro:* Risorse

**[y=893] `span`** — #fafafa / 16px / w300

Risorse

**[y=923] `p`** — #fafafa / 16px / w300

Blog

  *in grassetto/link dentro:* Blog

**[y=927] `span`** — #fafafa / 16px / w300

Blog

**[y=1092] `p`** — #fafafa / 12.544px / w300
...
**[y=1202] `span`** — #ebe9e0 / 12.544px / w300

Andrei Pascu Sales | FIRENZE (FI) VIALE GIACOMO MATTEOTTI | 15 CAP 50121 P.I. 02001850474 |

**[y=1221] `a`** — #a8a8a8 / 12.544px / w300 → `/privacy-dati-cookie-simili`

Privacy, dati, cookie e simili

**[y=1224] `span`** — #ebe9e0 / 12.544px / w300

Privacy, dati, cookie e simili

**[y=1277] `button`** — #fafafa / 12px / w400
