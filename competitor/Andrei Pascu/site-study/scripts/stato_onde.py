...
ONDE = [
    ...
    ("D", "T3 la macchina del funnel (le pagine -pre)", 15, [
        "30-pre-copy", "31-pre-checkout-cm", "32-pre-checkout-cmb", "33-outemail-pre",
        "34-outheadline-pre", "35-vendita101-pre", "36-pre-outviral-shop",
        "37-stripe-claude-speedrun", "38-presto-disponibile", "39-ricevi-email",
