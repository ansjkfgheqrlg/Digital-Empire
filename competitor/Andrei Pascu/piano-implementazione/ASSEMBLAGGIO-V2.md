# PIANO-IMPLEMENTAZIONE-ANDREI-PASCU — Assemblaggio V2

**Stato:** ASSEMBLAGGIO MECCANICO — non è il documento finale. Prodotto dallo Scagnozzo
dell'assemblaggio seguendo `STRUTTURA-DOCUMENTO-FINALE.md`, fondendo 6 fonti (2 draft V1 + 3
critiche P1 + 1 critica P2). Nessuna decisione presa qui: dove le fonti P1 (S2-denaro e
Sentinella-verità) divergono, le due versioni sono scritte affiancate e marcate
`⚖️ DA DECIDERE IN P3`. Dove P2 (Fable) dichiara che un colpo CROLLA, l'azione colpita torna viva
con nota «colpo respinto in P2»; se REGGE, porta la nota del colpo; se PARZIALE, entrambe.

**Fonti:** `DRAFT-V1-A-lanci.md` (Doom Bot A, 27 azioni corsie C1/C2) · `DRAFT-V1-B-capacita.md`
(Doom Bot B, 4 verdetti go/no-go) · `P1-CRITICA-S1-governo.md` (Sentinella S1) ·
`P1-CRITICA-S2-denaro.md` (Sentinella S2) · `P1-CRITICA-sentinella-verita.md` (Sentinella
indipendente, angolo denaro/verità) · `P2-FABLE-critica-della-critica.md` (Fable, giro 3).

---

## 1. La pagina che conta

> DA SCRIVERE DA EMPERATOR IN P3
