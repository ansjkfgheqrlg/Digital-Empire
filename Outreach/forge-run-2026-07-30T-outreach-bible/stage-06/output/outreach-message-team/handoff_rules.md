...
| rule-keeper | message-writer | Draft respinto | `pilastri_violati`, `motivazione` | JSON, vedi `communication_protocol.md` §3 | `motivazione` deve citare un `#atom-` di master.md |
