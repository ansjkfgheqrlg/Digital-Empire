...
(`master.md#atom-followup-3-step-rates`): "i soldi non sono mai nel primo messaggio,
...
`master.md#atom-pillar-3-valore-anticipato` e seguenti) solo perché "è l'ultimo
