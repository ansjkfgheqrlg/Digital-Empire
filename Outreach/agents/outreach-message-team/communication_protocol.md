...
```json
{"payload": {"pilastri_violati": ["pilastro_3_valore_anticipato"], "motivazione": "str puntuale, con citazione della regola violata da bibbia-messaggi-outreach.md"}, "expectation": "Riscrivi SOLO le parti che violano i pilastri indicati, non l'intero messaggio se non necessario"}
```
...
Il rifiuto deve sempre citare l'atomo esatto violato da `bibbia-messaggi-outreach.md` (non un giudizio
...
> call di 30 minuti?" al primo messaggio. Vedi bibbia-messaggi-outreach.md#atom-pillar-4-microcommitment:
