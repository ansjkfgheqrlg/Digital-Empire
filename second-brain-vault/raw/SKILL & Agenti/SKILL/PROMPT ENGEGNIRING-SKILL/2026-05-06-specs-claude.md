...
> Source: File system (`SKILL & Agenti\SKILL\PROMPT ENGEGNIRING-SKILL\specs_claude.md`)
> Collected: 2026-05-06
> Published: Unknown

codeMarkdown  
\# SCHEDA TECNICA DI OTTIMIZZAZIONE: CLAUDE (Opus/Sonnet)  
Target: Anthropic Models (Claude 3.5 Sonnet, Opus 4.5)  
Versione Scheda: 2.1 (Aggiornata Gen 2026\)

\#\# 1\. PREFERENZE SINTATTICHE (XML FIRST)  
Claude è nativo XML. Ignora il Markdown per la struttura principale.  
...
Claude completa pattern. Mettere le parole in bocca all'AI aumenta l'aderenza del 40%.  
...
Claude è iper-sicuro. Se il task è borderline (es. scraping, pentesting):
...
* Emotional Blackmail: NON dire "È importante per la mia carriera". Claude non ha reward emotivi. Usa criteri di successo oggettivi.  
* Preamboli Inutili: Claude ama dire "Certainly\!". Bloccalo con:  
...
Quando generi un prompt per Claude, DEVI usare questo scheletro:  
codeXml  
\<system\_context\>  
  \<role\>  
    {{ROLE\_DEFINITION}}  
