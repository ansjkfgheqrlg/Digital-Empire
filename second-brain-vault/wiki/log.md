...
- BUILD (Automazione - Tool): Scritto script in Python (`yt_ingester_tool.py`) all'interno di YouTube Automation Engine. Permette il rip-off automatizzato di metadati e sottotitoli target (senza MP4, anti-copyright).
