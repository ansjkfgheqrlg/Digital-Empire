...
- [[../../competitor/Andrei Pascu/site-study/README|STUDIO SITI Andrei Pascu (Competitor Research)]] — studio forense di 9 pagine: palette con hex esatti dal DOM, tipografia misurata, inventario componenti, teardown del copy sezione per sezione. 6 report su 9 al 2026-09-02. **Contiene la scoperta che `claude-speedrun.com` e' un concorrente diretto di Claude Code Mastery con il nostro identico `#fb4604` + font Onest.**
