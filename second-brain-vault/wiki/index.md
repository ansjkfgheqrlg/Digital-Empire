...
- [[tools/Tool_VSCode_Toolchain|Toolchain VS Code]] — Scansione completa plugin editor (14 categorie, 3 fasce) mappata ai workflow W1-W10. Agente = solo Claude Code; mai format-on-save. Config condivisa in `.vscode/` (2026-07-20, dossier 19).
- [[tools/Tool_Youtube_Lead_Machine_Skill|Skill `/youtube-lead-machine`]] — Metodo ufficiale canale organico (MIR-11; prima skill forgiata da FORGE-AGENT-SKILL). Kernel + 6 references + evals + failure-modes; GATE PASS 7/7 (2026-07-20).
- [[tools/Tool_Youtube_Script_Factory|Skill YouTube Script Factory PRO]] — Fabbrica script W7 (7 componenti, 20 hook, mix 70/20/10, scoring 45pt, 3 tool python). Retrofit MIR-5 sprint 1: wrap canonico + tools/ estratti; legacy-wrapped (md intoccato ADR-003).
- [[tools/Tool_Client_Research_Engine|Skill CRO Ricerca — Client Research Engine]] — Intelligence pre-copy: 5 fasi R1-R5, Report Ricerca 10 sezioni con scoring, min 20 frasi esatte. Retrofit MIR-5 sprint 2: wrap canonico; ⚠️ manifest fantasma dichiarato (5 template = inline nel master). Zero tool by design.
- [[entities/Entity_Brand_Offer_DE|Brand-Offer DE (MKD)]] — Base canonica offerta/ICP/USP/TOV: da Materiale Agency via /forge (MIR-2, 2026-07-20). Ogni agente di vendita/copy parte da qui.
- Review APSOC sito istituzionale (MIR-12, 2026-07-20): `Agency page - Copia/COPY-REVIEW-APSOC-SITO.md` — 78/100, P0 bloccanti (claim senza fonte, tracking 0%, form fake-success, GDPR, offerta doppia 15 vs 40 min) + ASK Q1-Q3 per Max.
...
### YouTube Marketing / Lead Generation
- [[01 - Projects/Project_YouTube_Lead_Machine|🎬 Project: YouTube Lead Machine]] — Lancio canale YouTube Digital Empire come sistema di acquisizione clienti CRO (strategia: `Formazzione/Youtube/STRATEGIA-YOUTUBE-LEAD-MAGNET.md`). Ingerito 2026-07-19: 7 video analizzati + 2 infografiche, note in `Formazzione/Youtube/note-video/01-07`.
- [[sources/Source_MediaProfit_YouTube_Lead_Machine|Media Profit — Metodo YouTube Lead Machine (5 video)]] — Lorenzo Ricchieri: views≠clienti, 4 pilastri contenuto, funnel TOFU-MOFU-BOFU (MOFU=audit live), metodo 4h/settimana (time blocking+batching), setup canale, script hook 3/10/30s.
- [[sources/Source_Hormozi_Lead_Magnet|Alex Hormozi — Lead Magnet per 1000s di Lead]] — Mini-offerta che risolve un problema stretto e rivela quello core. 3 tipi (rivela problema ⭐ / prova / step-di-molti), 4 delivery, naming=2-10x (testa!), CTA chiare.
- [[sources/Source_ThinkMedia_YouTube_Lead_Framework|Think Media — YouTube Business Growth Framework]] — Sean Cannell: right views (ICP+problemi, prompt AI) → lead magnet → sales process → trust = (consistenza+valore)×tempo. Validazione USA del metodo Media Profit.
- [[concepts/Concept_YouTube_Funnel_TOFU_MOFU_BOFU|Concept: Funnel Contenuti YouTube TOFU-MOFU-BOFU]] — 3 livelli video mappati su Schwartz (punta ai livelli 3-4). MOFU = format audit dal vivo: lo spettatore si immagina cliente. Rotazione azione→educazione→prova sociale.
- [[concepts/Concept_Lead_Magnet_Hormozi|Concept: Lead Magnet (metodo Hormozi)]] — 4 regole: tipo/delivery/naming/CTA. Non risolvere il problema core col magnet. Applicato a CRO: speed test sito, audit video gratuito, checklist 21 punti, template product page.
- [[concepts/Concept_Speed_To_Lead|Concept: Speed to Lead]] — +391% conversioni rispondendo in 1 minuto (HBR); 78% compra dalla prima azienda che contatta. Automazione conferma+qualifica, contatto 1-click Calendly/WhatsApp.
