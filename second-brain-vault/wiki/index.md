...
- [[tools/Tool_Pipeline_Libri_KDP|Pipeline Produzione Libri KDP]] — engine `book_project.py` + SOP 7 step + `niche_finder.py`. Primo output: [[entities/Entity_The_Quiet_Hours_Libro_KDP|"The Quiet Hours"]] (backfill 2026-08-23).
