...
> Path: [[Map - Crea_Siti|Crea siti > skills > site-qa]]

## Content

---
description: Quality assurance completo del sito web. Lancia 4 agenti in parallelo: site-qa-html (validità e struttura), site-qa-accessibility (WCAG 2.1 AA), site-qa-performance (Core Web Vitals), site-qa-mobile (responsive e cross-browser). Produce QA-REPORT.md con severity rating e fix instructions.
---
