...
print(f"Skill dedicated file CheckpointManagementSkill - owners {len(CheckpointManagementSkill.owner_agents)} - trigger {'CheckpointManagementSkill'}")
