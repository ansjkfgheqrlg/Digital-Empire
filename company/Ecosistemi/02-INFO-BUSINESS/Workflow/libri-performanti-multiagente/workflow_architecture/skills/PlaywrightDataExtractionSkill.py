...
print(f"Skill dedicated file PlaywrightDataExtractionSkill - owners {len(PlaywrightDataExtractionSkill.owner_agents)} - trigger {'PlaywrightDataExtractionSkill'}")
