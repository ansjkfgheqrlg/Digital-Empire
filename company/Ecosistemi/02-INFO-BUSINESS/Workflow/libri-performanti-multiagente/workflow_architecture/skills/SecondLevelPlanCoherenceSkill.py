...
print(f"Skill dedicated file SecondLevelPlanCoherenceSkill - owners {len(SecondLevelPlanCoherenceSkill.owner_agents)} - trigger {'SecondLevelPlanCoherenceSkill'}")
