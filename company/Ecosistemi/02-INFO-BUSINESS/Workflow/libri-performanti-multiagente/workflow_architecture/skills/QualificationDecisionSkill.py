...
print(f"Skill dedicated file QualificationDecisionSkill - owners {len(QualificationDecisionSkill.owner_agents)} - trigger {'QualificationDecisionSkill'}")
