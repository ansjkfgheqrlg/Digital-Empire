...
MEMBERS = ['EditingLeader', 'EditingCoordinatorAgent', 'FinalProofreaderAgent', 'CrossReferenceCheckerAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Team EditingTeam in ProductionEcosystem - perfetta sincronia armonia", "Gestisce flusso interno con TeamSynchronyProtocol", "Checkpoint condiviso", "Self-healing sincronizzato", "Handoff esterno 8-step"],
    input_source="Handoff package + memory ProductionEcosystem + sync signals",
