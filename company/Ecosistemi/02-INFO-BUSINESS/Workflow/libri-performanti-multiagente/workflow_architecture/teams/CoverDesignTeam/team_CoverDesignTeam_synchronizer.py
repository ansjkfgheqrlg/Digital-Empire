...
# Team definition - non è più un unico file per tutti i team, ma file dedicato per CoverDesignTeam
# Ogni agente ha suo file dedicato sotto questa cartella e lavora in sincronia perfetta

TEAM_NAME = "CoverDesignTeam"
ECOSYSTEM = "VisualEcosystem"
SUB_ECOSYSTEM = "CoverSub"
LEADER = "CoverDesignLeader"
MEMBERS = ['CoverDesignLeader', 'CoverConceptAgent', 'CoverPromptCreatorAgent', 'CoverGeneratorAgent', 'CoverQualityReviewerAgent', 'CoverRevisionAgent', 'CoverMarketFitAnalystAgent', 'CoverPromptMicroAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Responsabilita principale CoverDesignTeam in VisualEcosystem", "Gestisce flusso interno con TeamSynchronyProtocol", "Valida output con validator agent", "Crea checkpoint condiviso via CheckpointManagerAgent", "Gestisce self-healing sincronizzato intra-team", "Esegue handoff esterno 8-step sincronizzato via InterTeamHarmonyProtocol"],
    ...
    external_handoff_protocol={
        ...
        "steps": [
            "1. CoverDesignLeader (LEADER L3) crea handoff package structured output decisions risks checkpoint ref + harmony_status synchronized",
