...
"""
AGENTE DEDICATO - File singolo per CoverDesignLeader
...
CoverDesignLeader = Agent(
    ...
    role="Leader CoverDesignTeam cover concept prompt generazione review critica non skippabile - L3 - Team CoverDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=3,
    team="CoverDesignTeam",
    ...
    decision_logic="""Come agente CoverDesignLeader L3 in team CoverDesignTeam ecosistema VisualEcosystem sub CoverSub:
    Leader CoverDesignTeam cover concept prompt generazione review critica non skippabile
    ...
    """,
    connections={"reports_to": ["VisualEcosystemController"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_CoverDesignTeam"]},
...
class CoverDesignLeader_SynchronizedWrapper:
...
CoverDesignLeader_sync = CoverDesignLeader_SynchronizedWrapper(CoverDesignLeader)

def get_agent():
    return CoverDesignLeader

def get_synchronized_wrapper():
    return CoverDesignLeader_sync

print(f"Agent file dedicated CoverDesignLeader L3 Team CoverDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
