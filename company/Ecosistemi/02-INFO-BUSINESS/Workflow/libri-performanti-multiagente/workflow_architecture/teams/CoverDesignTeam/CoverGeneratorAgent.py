...
"""
AGENTE DEDICATO - File singolo per CoverGeneratorAgent
...
CoverGeneratorAgent = Agent(
    ...
    role="Genera cover salva via Playwright asset critico - operational Playwright - L5 - Team CoverDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="CoverDesignTeam",
    ecosystem="VisualEcosystem",
    sub_ecosystem="CoverSub",
    inputs=["cover_prompt"],
    outputs=["cover_generated_raw"],
    decision_logic="""Come agente CoverGeneratorAgent L5 in team CoverDesignTeam ecosistema VisualEcosystem sub CoverSub:
    Genera cover salva via Playwright asset critico - operational Playwright
...
class CoverGeneratorAgent_SynchronizedWrapper:
...
CoverGeneratorAgent_sync = CoverGeneratorAgent_SynchronizedWrapper(CoverGeneratorAgent)

def get_agent():
    return CoverGeneratorAgent

def get_synchronized_wrapper():
    return CoverGeneratorAgent_sync

print(f"Agent file dedicated CoverGeneratorAgent L5 Team CoverDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
