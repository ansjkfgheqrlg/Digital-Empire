...
"""
AGENTE DEDICATO - File singolo per ReviewSiteFinderAgent
...
ReviewSiteFinderAgent = Agent(
    ...
    role="Trova siti che analizzano Amazon reviews via Playwright navigation - operational - L5 - Team ReviewAnalysisResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="ReviewAnalysisResearchTeam",
    ...
    decision_logic="""Come agente ReviewSiteFinderAgent L5 in team ReviewAnalysisResearchTeam ecosistema ResearchEcosystem sub ReviewSub:
    Trova siti che analizzano Amazon reviews via Playwright navigation - operational
...
class ReviewSiteFinderAgent_SynchronizedWrapper:
...
ReviewSiteFinderAgent_sync = ReviewSiteFinderAgent_SynchronizedWrapper(ReviewSiteFinderAgent)

def get_agent():
    return ReviewSiteFinderAgent

def get_synchronized_wrapper():
    return ReviewSiteFinderAgent_sync

print(f"Agent file dedicated ReviewSiteFinderAgent L5 Team ReviewAnalysisResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
