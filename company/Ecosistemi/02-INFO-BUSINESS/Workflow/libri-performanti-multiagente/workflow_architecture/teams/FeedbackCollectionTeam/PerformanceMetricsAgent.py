...
"""
AGENTE DEDICATO - File singolo per PerformanceMetricsAgent
...
PerformanceMetricsAgent = Agent(
    ...
    role="Calcola metriche performance per fase feedback 6 segnali - support - L6 - Team FeedbackCollectionTeam - Ecosistema AutoImprovementEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="FeedbackCollectionTeam",
    ecosystem="AutoImprovementEcosystem",
    sub_ecosystem="FeedbackSub",
    inputs=["collected_outcomes", "phase_logs"],
    outputs=["performance_metrics_per_phase"],
    decision_logic="""Come agente PerformanceMetricsAgent L6 in team FeedbackCollectionTeam ecosistema AutoImprovementEcosystem sub FeedbackSub:
    Calcola metriche performance per fase feedback 6 segnali - support
...
class PerformanceMetricsAgent_SynchronizedWrapper:
...
PerformanceMetricsAgent_sync = PerformanceMetricsAgent_SynchronizedWrapper(PerformanceMetricsAgent)

def get_agent():
    return PerformanceMetricsAgent

def get_synchronized_wrapper():
    return PerformanceMetricsAgent_sync

print(f"Agent file dedicated PerformanceMetricsAgent L6 Team FeedbackCollectionTeam Ecosistema AutoImprovementEcosystem - perfect synchrony harmony initialized")
