...
"""
AGENTE DEDICATO - File singolo per AmazonDetailExtractorAgent
...
AmazonDetailExtractorAgent = Agent(
    ...
    role="Atomic extractor dettagli libro singola pagina Amazon - micro - L7 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=7,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["extraction_request", "selectors", "url"],
    outputs=["captured_data", "extraction_success_flag"],
    decision_logic="""Come agente AmazonDetailExtractorAgent L7 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Atomic extractor dettagli libro singola pagina Amazon - micro
...
class AmazonDetailExtractorAgent_SynchronizedWrapper:
...
AmazonDetailExtractorAgent_sync = AmazonDetailExtractorAgent_SynchronizedWrapper(AmazonDetailExtractorAgent)

def get_agent():
    return AmazonDetailExtractorAgent

def get_synchronized_wrapper():
    return AmazonDetailExtractorAgent_sync

print(f"Agent file dedicated AmazonDetailExtractorAgent L7 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
