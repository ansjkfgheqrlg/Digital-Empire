...
"""
AGENTE DEDICATO - File singolo per AmazonPageNavigatorAgent
...
AmazonPageNavigatorAgent = Agent(
    ...
    role="Atomic navigator specifica per pagine Amazon search results - micro atomic - L7 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=7,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["navigation_request", "url"],
    outputs=["navigation_result", "page_loaded_flag"],
    decision_logic="""Come agente AmazonPageNavigatorAgent L7 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Atomic navigator specifica per pagine Amazon search results - micro atomic
    ...
    """,
    connections={"reports_to": ["AmazonResearchLeader"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_AmazonKeywordResearchTeam"]},
...
class AmazonPageNavigatorAgent_SynchronizedWrapper:
...
AmazonPageNavigatorAgent_sync = AmazonPageNavigatorAgent_SynchronizedWrapper(AmazonPageNavigatorAgent)

def get_agent():
    return AmazonPageNavigatorAgent

def get_synchronized_wrapper():
    return AmazonPageNavigatorAgent_sync

print(f"Agent file dedicated AmazonPageNavigatorAgent L7 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
