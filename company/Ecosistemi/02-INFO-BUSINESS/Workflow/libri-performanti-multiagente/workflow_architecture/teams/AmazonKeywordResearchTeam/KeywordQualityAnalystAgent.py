...
"""
AGENTE DEDICATO - File singolo per KeywordQualityAnalystAgent
...
KeywordQualityAnalystAgent = Agent(
    ...
    role="Analizza qualita keyword Amazon search signals - senior tactical decision authority - L4 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["keyword_variations", "search_results_raw"],
    outputs=["keyword_quality_score", "quality_evidence"],
    decision_logic="""Come agente KeywordQualityAnalystAgent L4 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Analizza qualita keyword Amazon search signals - senior tactical decision authority
...
class KeywordQualityAnalystAgent_SynchronizedWrapper:
...
KeywordQualityAnalystAgent_sync = KeywordQualityAnalystAgent_SynchronizedWrapper(KeywordQualityAnalystAgent)

def get_agent():
    return KeywordQualityAnalystAgent

def get_synchronized_wrapper():
    return KeywordQualityAnalystAgent_sync

print(f"Agent file dedicated KeywordQualityAnalystAgent L4 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
