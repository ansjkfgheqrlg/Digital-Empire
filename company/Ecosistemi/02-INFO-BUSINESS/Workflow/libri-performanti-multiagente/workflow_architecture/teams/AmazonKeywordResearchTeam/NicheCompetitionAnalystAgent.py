...
"""
AGENTE DEDICATO - File singolo per NicheCompetitionAnalystAgent
...
NicheCompetitionAnalystAgent = Agent(
    ...
    role="Analizza competizione nicchia da dati Amazon - senior - L4 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["amazon_search_results", "book_opportunities"],
    outputs=["competition_level", "competition_evidence"],
    decision_logic="""Come agente NicheCompetitionAnalystAgent L4 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Analizza competizione nicchia da dati Amazon - senior
...
class NicheCompetitionAnalystAgent_SynchronizedWrapper:
...
NicheCompetitionAnalystAgent_sync = NicheCompetitionAnalystAgent_SynchronizedWrapper(NicheCompetitionAnalystAgent)

def get_agent():
    return NicheCompetitionAnalystAgent

def get_synchronized_wrapper():
    return NicheCompetitionAnalystAgent_sync

print(f"Agent file dedicated NicheCompetitionAnalystAgent L4 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
