...
# Team definition - non è più un unico file per tutti i team, ma file dedicato per AmazonKeywordResearchTeam
# Ogni agente ha suo file dedicato sotto questa cartella e lavora in sincronia perfetta

TEAM_NAME = "AmazonKeywordResearchTeam"
ECOSYSTEM = "ResearchEcosystem"
SUB_ECOSYSTEM = "PlaywrightOps"
LEADER = "AmazonResearchLeader"
MEMBERS = ['AmazonResearchLeader', 'KeywordGeneratorAgent', 'AmazonSearchAgent', 'AmazonDataExtractorAgent', 'AmazonResultsValidatorAgent', 'KeywordQualityAnalystAgent', 'NicheCompetitionAnalystAgent', 'SearchQualityValidatorAgent', 'NicheViabilityValidatorAgent', 'AmazonPageNavigatorAgent', 'AmazonDetailExtractorAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Responsabilita principale AmazonKeywordResearchTeam in ResearchEcosystem", "Gestisce flusso interno con TeamSynchronyProtocol", "Valida output con validator agent", "Crea checkpoint condiviso via CheckpointManagerAgent", "Gestisce self-healing sincronizzato intra-team", "Esegue handoff esterno 8-step sincronizzato via InterTeamHarmonyProtocol"],
    input_source="Handoff package da ecosistema precedente + memory ResearchEcosystem + sync signals",
    output_target="Prossimo team/ecosistema + memory ResearchEcosystem + checkpoint condiviso + sync ack",
    ...
    external_handoff_protocol={
        ...
        "steps": [
            "1. AmazonResearchLeader (LEADER L3) crea handoff package structured output decisions risks checkpoint ref + harmony_status synchronized",
