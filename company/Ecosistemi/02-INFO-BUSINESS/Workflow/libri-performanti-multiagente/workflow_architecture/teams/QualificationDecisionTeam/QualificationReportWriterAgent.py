...
"""
AGENTE DEDICATO - File singolo per QualificationReportWriterAgent
...
QualificationReportWriterAgent = Agent(
    ...
    role="Scrive report qualifica finale strutturato GO NO-GO motivata trace - operational - L5 - Team QualificationDecisionTeam - Ecosistema QualificationEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="QualificationDecisionTeam",
    ecosystem="QualificationEcosystem",
    sub_ecosystem="DecisionSub",
    inputs=["aggregated_decision", "prioritized_risks"],
    outputs=["final_qualification_report"],
    decision_logic="""Come agente QualificationReportWriterAgent L5 in team QualificationDecisionTeam ecosistema QualificationEcosystem sub DecisionSub:
    Scrive report qualifica finale strutturato GO NO-GO motivata trace - operational
...
class QualificationReportWriterAgent_SynchronizedWrapper:
...
QualificationReportWriterAgent_sync = QualificationReportWriterAgent_SynchronizedWrapper(QualificationReportWriterAgent)

def get_agent():
    return QualificationReportWriterAgent

def get_synchronized_wrapper():
    return QualificationReportWriterAgent_sync

print(f"Agent file dedicated QualificationReportWriterAgent L5 Team QualificationDecisionTeam Ecosistema QualificationEcosystem - perfect synchrony harmony initialized")
