...
"""
AGENTE DEDICATO - File singolo per WritingProgressTrackerAgent
...
WritingProgressTrackerAgent = Agent(
    ...
    role="Traccia progresso scrittura capitoli paralleli - senior - L4 - Team BookWritingTeam - Ecosistema ProductionEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="BookWritingTeam",
    ecosystem="ProductionEcosystem",
    sub_ecosystem="WritingSub",
    inputs=["chapter_writing_status"],
    outputs=["progress_report", "eta"],
    decision_logic="""Come agente WritingProgressTrackerAgent L4 in team BookWritingTeam ecosistema ProductionEcosystem sub WritingSub:
    Traccia progresso scrittura capitoli paralleli - senior
...
class WritingProgressTrackerAgent_SynchronizedWrapper:
...
WritingProgressTrackerAgent_sync = WritingProgressTrackerAgent_SynchronizedWrapper(WritingProgressTrackerAgent)

def get_agent():
    return WritingProgressTrackerAgent

def get_synchronized_wrapper():
    return WritingProgressTrackerAgent_sync

print(f"Agent file dedicated WritingProgressTrackerAgent L4 Team BookWritingTeam Ecosistema ProductionEcosystem - perfect synchrony harmony initialized")
