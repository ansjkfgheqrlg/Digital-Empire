...
"""
AGENTE DEDICATO - File singolo per ConsistencyCheckerAgent
...
ConsistencyCheckerAgent = Agent(
    ...
    role="Controlla consistenza cross-chapters durante produzione - senior - L4 - Team BookWritingTeam - Ecosistema ProductionEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="BookWritingTeam",
    ...
    decision_logic="""Come agente ConsistencyCheckerAgent L4 in team BookWritingTeam ecosistema ProductionEcosystem sub WritingSub:
    Controlla consistenza cross-chapters durante produzione - senior
...
class ConsistencyCheckerAgent_SynchronizedWrapper:
...
ConsistencyCheckerAgent_sync = ConsistencyCheckerAgent_SynchronizedWrapper(ConsistencyCheckerAgent)

def get_agent():
    return ConsistencyCheckerAgent

def get_synchronized_wrapper():
    return ConsistencyCheckerAgent_sync

print(f"Agent file dedicated ConsistencyCheckerAgent L4 Team BookWritingTeam Ecosistema ProductionEcosystem - perfect synchrony harmony initialized")
