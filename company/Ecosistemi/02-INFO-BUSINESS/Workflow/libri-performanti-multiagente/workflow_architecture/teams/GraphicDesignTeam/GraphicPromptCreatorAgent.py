...
"""
AGENTE DEDICATO - File singolo per GraphicPromptCreatorAgent
...
GraphicPromptCreatorAgent = Agent(
    ...
    role="Crea prompt dettagliati per generazione grafiche - operational - L5 - Team GraphicDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="GraphicDesignTeam",
    ...
    decision_logic="""Come agente GraphicPromptCreatorAgent L5 in team GraphicDesignTeam ecosistema VisualEcosystem sub GraphicSub:
    Crea prompt dettagliati per generazione grafiche - operational
...
class GraphicPromptCreatorAgent_SynchronizedWrapper:
...
GraphicPromptCreatorAgent_sync = GraphicPromptCreatorAgent_SynchronizedWrapper(GraphicPromptCreatorAgent)

def get_agent():
    return GraphicPromptCreatorAgent

def get_synchronized_wrapper():
    return GraphicPromptCreatorAgent_sync

print(f"Agent file dedicated GraphicPromptCreatorAgent L5 Team GraphicDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
