...
"""
AGENTE DEDICATO - File singolo per GraphicStyleEnforcerAgent
...
GraphicStyleEnforcerAgent = Agent(
    ...
    role="Impone stile uniforme grafiche - operational - L5 - Team GraphicDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="GraphicDesignTeam",
    ecosystem="VisualEcosystem",
    sub_ecosystem="GraphicSub",
    inputs=["graphics", "style_notes"],
    outputs=["style_enforced_graphics"],
    decision_logic="""Come agente GraphicStyleEnforcerAgent L5 in team GraphicDesignTeam ecosistema VisualEcosystem sub GraphicSub:
    Impone stile uniforme grafiche - operational
...
class GraphicStyleEnforcerAgent_SynchronizedWrapper:
...
GraphicStyleEnforcerAgent_sync = GraphicStyleEnforcerAgent_SynchronizedWrapper(GraphicStyleEnforcerAgent)

def get_agent():
    return GraphicStyleEnforcerAgent

def get_synchronized_wrapper():
    return GraphicStyleEnforcerAgent_sync

print(f"Agent file dedicated GraphicStyleEnforcerAgent L5 Team GraphicDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
