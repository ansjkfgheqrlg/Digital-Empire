...
"""
AGENTE DEDICATO - File singolo per GraphicDesignLeader
...
GraphicDesignLeader = Agent(
    ...
    role="Leader GraphicDesignTeam creazione prompt grafiche generazione quality review revision loop - L3 - Team GraphicDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=3,
    team="GraphicDesignTeam",
    ...
    decision_logic="""Come agente GraphicDesignLeader L3 in team GraphicDesignTeam ecosistema VisualEcosystem sub GraphicSub:
    Leader GraphicDesignTeam creazione prompt grafiche generazione quality review revision loop
    ...
    """,
    connections={"reports_to": ["VisualEcosystemController"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_GraphicDesignTeam"]},
...
class GraphicDesignLeader_SynchronizedWrapper:
...
GraphicDesignLeader_sync = GraphicDesignLeader_SynchronizedWrapper(GraphicDesignLeader)

def get_agent():
    return GraphicDesignLeader

def get_synchronized_wrapper():
    return GraphicDesignLeader_sync

print(f"Agent file dedicated GraphicDesignLeader L3 Team GraphicDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
