...
"""
AGENTE DEDICATO - File singolo per RawDataArchiverAgent
...
RawDataArchiverAgent = Agent(
    ...
    role="Archivia raw data da Playwright con refs e screenshot - operational - L5 - Team DataPersistenceTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="DataPersistenceTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PersistenceSub",
    inputs=["raw_data", "screenshot_refs"],
    outputs=["archived_raw_data_refs"],
    decision_logic="""Come agente RawDataArchiverAgent L5 in team DataPersistenceTeam ecosistema ResearchEcosystem sub PersistenceSub:
    Archivia raw data da Playwright con refs e screenshot - operational
...
class RawDataArchiverAgent_SynchronizedWrapper:
...
RawDataArchiverAgent_sync = RawDataArchiverAgent_SynchronizedWrapper(RawDataArchiverAgent)

def get_agent():
    return RawDataArchiverAgent

def get_synchronized_wrapper():
    return RawDataArchiverAgent_sync

print(f"Agent file dedicated RawDataArchiverAgent L5 Team DataPersistenceTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
