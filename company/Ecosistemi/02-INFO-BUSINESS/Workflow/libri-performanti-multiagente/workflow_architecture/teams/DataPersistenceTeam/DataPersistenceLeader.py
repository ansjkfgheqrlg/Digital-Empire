...
"""
AGENTE DEDICATO - File singolo per DataPersistenceLeader
...
DataPersistenceLeader = Agent(
    ...
    role="Leader DataPersistenceTeam garantisce salvataggio via Playwright formatting validation checkpoint CP1 - L3 - Team DataPersistenceTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=3,
    team="DataPersistenceTeam",
    ...
    decision_logic="""Come agente DataPersistenceLeader L3 in team DataPersistenceTeam ecosistema ResearchEcosystem sub PersistenceSub:
    Leader DataPersistenceTeam garantisce salvataggio via Playwright formatting validation checkpoint CP1
    ...
    """,
    connections={"reports_to": ["ResearchEcosystemController"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_DataPersistenceTeam"]},
...
class DataPersistenceLeader_SynchronizedWrapper:
...
DataPersistenceLeader_sync = DataPersistenceLeader_SynchronizedWrapper(DataPersistenceLeader)

def get_agent():
    return DataPersistenceLeader

def get_synchronized_wrapper():
    return DataPersistenceLeader_sync

print(f"Agent file dedicated DataPersistenceLeader L3 Team DataPersistenceTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
