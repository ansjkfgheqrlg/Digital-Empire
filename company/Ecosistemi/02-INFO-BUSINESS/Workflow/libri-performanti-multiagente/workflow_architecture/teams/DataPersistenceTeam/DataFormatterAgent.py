...
"""
AGENTE DEDICATO - File singolo per DataFormatterAgent
...
DataFormatterAgent = Agent(
    ...
    role="Formatta dati in structured_output pronto per qualifica - operational - L5 - Team DataPersistenceTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="DataPersistenceTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PersistenceSub",
    inputs=["raw_book_data", "raw_review_data"],
    outputs=["formatted_structured_output"],
    decision_logic="""Come agente DataFormatterAgent L5 in team DataPersistenceTeam ecosistema ResearchEcosystem sub PersistenceSub:
    Formatta dati in structured_output pronto per qualifica - operational
...
class DataFormatterAgent_SynchronizedWrapper:
...
DataFormatterAgent_sync = DataFormatterAgent_SynchronizedWrapper(DataFormatterAgent)

def get_agent():
    return DataFormatterAgent

def get_synchronized_wrapper():
    return DataFormatterAgent_sync

print(f"Agent file dedicated DataFormatterAgent L5 Team DataPersistenceTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
