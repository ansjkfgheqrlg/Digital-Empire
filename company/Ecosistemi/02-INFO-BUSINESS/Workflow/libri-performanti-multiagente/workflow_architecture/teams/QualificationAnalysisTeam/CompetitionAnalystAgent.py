...
"""
AGENTE DEDICATO - File singolo per CompetitionAnalystAgent
...
CompetitionAnalystAgent = Agent(
    ...
    role="Analizza competizione livello nicchia da segnali Amazon - senior - L4 - Team QualificationAnalysisTeam - Ecosistema QualificationEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="QualificationAnalysisTeam",
    ecosystem="QualificationEcosystem",
    sub_ecosystem="AnalysisSub",
    inputs=["book_data", "amazon_search_results"],
    outputs=["competition_level"],
    decision_logic="""Come agente CompetitionAnalystAgent L4 in team QualificationAnalysisTeam ecosistema QualificationEcosystem sub AnalysisSub:
    Analizza competizione livello nicchia da segnali Amazon - senior
...
class CompetitionAnalystAgent_SynchronizedWrapper:
...
CompetitionAnalystAgent_sync = CompetitionAnalystAgent_SynchronizedWrapper(CompetitionAnalystAgent)

def get_agent():
    return CompetitionAnalystAgent

def get_synchronized_wrapper():
    return CompetitionAnalystAgent_sync

print(f"Agent file dedicated CompetitionAnalystAgent L4 Team QualificationAnalysisTeam Ecosistema QualificationEcosystem - perfect synchrony harmony initialized")
