...
"""
AGENTE DEDICATO - File singolo per ImprovementPlanWriterAgent
...
ImprovementPlanWriterAgent = Agent(
    ...
    role="Scrive improvement plans prioritizzati - support - L6 - Team ImprovementPlanningTeam - Ecosistema AutoImprovementEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="ImprovementPlanningTeam",
    ecosystem="AutoImprovementEcosystem",
    sub_ecosystem="PlanningSub",
    inputs=["ranked_improvements"],
    outputs=["improvement_plans_written"],
    decision_logic="""Come agente ImprovementPlanWriterAgent L6 in team ImprovementPlanningTeam ecosistema AutoImprovementEcosystem sub PlanningSub:
    Scrive improvement plans prioritizzati - support
    ...
    """,
    connections={"reports_to": ["ImprovementPlanningLeader"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_ImprovementPlanningTeam"]},
...
class ImprovementPlanWriterAgent_SynchronizedWrapper:
...
ImprovementPlanWriterAgent_sync = ImprovementPlanWriterAgent_SynchronizedWrapper(ImprovementPlanWriterAgent)

def get_agent():
    return ImprovementPlanWriterAgent

def get_synchronized_wrapper():
    return ImprovementPlanWriterAgent_sync

print(f"Agent file dedicated ImprovementPlanWriterAgent L6 Team ImprovementPlanningTeam Ecosistema AutoImprovementEcosystem - perfect synchrony harmony initialized")
