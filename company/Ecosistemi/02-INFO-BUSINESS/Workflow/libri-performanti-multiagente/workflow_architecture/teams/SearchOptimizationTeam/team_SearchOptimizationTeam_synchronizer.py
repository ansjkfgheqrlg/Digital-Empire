...
TEAM_NAME = "SearchOptimizationTeam"
ECOSYSTEM = "ResearchEcosystem"
SUB_ECOSYSTEM = "OptimizationSub"
LEADER = "SearchOptimizationLeader"
MEMBERS = ['SearchOptimizationLeader', 'SearchStrategyOptimizerAgent', 'PlaywrightRotationManagerAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Team SearchOptimizationTeam in ResearchEcosystem - perfetta sincronia armonia", "Gestisce flusso interno con TeamSynchronyProtocol", "Checkpoint condiviso", "Self-healing sincronizzato", "Handoff esterno 8-step"],
