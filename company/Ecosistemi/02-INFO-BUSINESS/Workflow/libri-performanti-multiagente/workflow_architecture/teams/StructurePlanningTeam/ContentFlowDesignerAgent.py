...
"""
AGENTE DEDICATO - File singolo per ContentFlowDesignerAgent
...
ContentFlowDesignerAgent = Agent(
    ...
    role="Progetta flusso contenuti tra capitoli - senior - L4 - Team StructurePlanningTeam - Ecosistema PlanningEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="StructurePlanningTeam",
    ...
    decision_logic="""Come agente ContentFlowDesignerAgent L4 in team StructurePlanningTeam ecosistema PlanningEcosystem sub StructureSub:
    Progetta flusso contenuti tra capitoli - senior
...
class ContentFlowDesignerAgent_SynchronizedWrapper:
...
ContentFlowDesignerAgent_sync = ContentFlowDesignerAgent_SynchronizedWrapper(ContentFlowDesignerAgent)

def get_agent():
    return ContentFlowDesignerAgent

def get_synchronized_wrapper():
    return ContentFlowDesignerAgent_sync

print(f"Agent file dedicated ContentFlowDesignerAgent L4 Team StructurePlanningTeam Ecosistema PlanningEcosystem - perfect synchrony harmony initialized")
