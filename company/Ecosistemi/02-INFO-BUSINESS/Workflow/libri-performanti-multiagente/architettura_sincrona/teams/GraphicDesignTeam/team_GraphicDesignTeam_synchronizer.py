...
# Team definition - non è più un unico file per tutti i team, ma file dedicato per GraphicDesignTeam
# Ogni agente ha suo file dedicato sotto questa cartella e lavora in sincronia perfetta

TEAM_NAME = "GraphicDesignTeam"
ECOSYSTEM = "VisualEcosystem"
SUB_ECOSYSTEM = "GraphicSub"
LEADER = "GraphicDesignLeader"
MEMBERS = ['GraphicDesignLeader', 'GraphicPromptCreatorAgent', 'GraphicGeneratorAgent', 'GraphicQualityReviewerAgent', 'GraphicRevisionAgent', 'GraphicStyleEnforcerAgent', 'VisualConsistencyCheckerAgent', 'GraphicPromptMicroAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Responsabilita principale GraphicDesignTeam in VisualEcosystem", "Gestisce flusso interno con TeamSynchronyProtocol", "Valida output con validator agent", "Crea checkpoint condiviso via CheckpointManagerAgent", "Gestisce self-healing sincronizzato intra-team", "Esegue handoff esterno 8-step sincronizzato via InterTeamHarmonyProtocol"],
    ...
    external_handoff_protocol={
        ...
        "steps": [
            "1. GraphicDesignLeader (LEADER L3) crea handoff package structured output decisions risks checkpoint ref + harmony_status synchronized",
