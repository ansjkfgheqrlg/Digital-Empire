...
TEAM_NAME = "KeywordExpansionTeam"
ECOSYSTEM = "ResearchEcosystem"
SUB_ECOSYSTEM = "ExpansionSub"
LEADER = "KeywordExpansionLeader"
MEMBERS = ['KeywordExpansionLeader', 'KeywordVariationGeneratorAgent', 'SemanticKeywordExpanderAgent', 'LongTailKeywordAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Team KeywordExpansionTeam in ResearchEcosystem - perfetta sincronia armonia", "Gestisce flusso interno con TeamSynchronyProtocol", "Checkpoint condiviso", "Self-healing sincronizzato", "Handoff esterno 8-step"],
    input_source="Handoff package + memory ResearchEcosystem + sync signals",
