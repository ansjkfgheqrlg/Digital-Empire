...
ContentFlowDesignerAgent = Agent(
    ...
    role="Progetta flusso contenuti tra capitoli - senior - L4 Team ContentPlanningTeam Ecosistema PlanningEcosystem - perfetta sincronia armonia",
    hierarchy_level=4,
    ...
    playwright_usage="real operational tool" if "Playwright" in "ContentFlowDesignerAgent" or "Search" in "ContentFlowDesignerAgent" or "Extractor" in "ContentFlowDesignerAgent" else None,
...
print(f"Agent dedicated ContentFlowDesignerAgent L4 Team ContentPlanningTeam - perfect synchrony harmony")
