...
# Team definition - non è più un unico file per tutti i team, ma file dedicato per ProductionQualityTeam
# Ogni agente ha suo file dedicato sotto questa cartella e lavora in sincronia perfetta

TEAM_NAME = "ProductionQualityTeam"
ECOSYSTEM = "ProductionEcosystem"
SUB_ECOSYSTEM = "QualitySub"
LEADER = "ProductionQualityLeader"
MEMBERS = ['ProductionQualityLeader', 'ManuscriptValidatorAgent', 'PlanComplianceCheckerAgent', 'FinalApprovalAgent', 'QualityMetricsCalculatorAgent', 'ContentValidationAgent']
...
TEAM_DEFINITION = Team(
    ...
    external_handoff_protocol={
        ...
        "steps": [
            "1. ProductionQualityLeader (LEADER L3) crea handoff package structured output decisions risks checkpoint ref + harmony_status synchronized",
