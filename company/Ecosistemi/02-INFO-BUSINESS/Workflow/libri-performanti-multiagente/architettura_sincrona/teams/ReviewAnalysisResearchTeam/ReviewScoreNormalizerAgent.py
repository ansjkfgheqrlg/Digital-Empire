...
"""
AGENTE DEDICATO - File singolo per ReviewScoreNormalizerAgent
...
ReviewScoreNormalizerAgent = Agent(
    ...
    role="Normalizza diversi scoring systems in formato unificato - support - L6 - Team ReviewAnalysisResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="ReviewAnalysisResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="ReviewSub",
    inputs=["review_scores_various_formats"],
    outputs=["normalized_review_scores_unified"],
    decision_logic="""Come agente ReviewScoreNormalizerAgent L6 in team ReviewAnalysisResearchTeam ecosistema ResearchEcosystem sub ReviewSub:
    Normalizza diversi scoring systems in formato unificato - support
...
class ReviewScoreNormalizerAgent_SynchronizedWrapper:
...
ReviewScoreNormalizerAgent_sync = ReviewScoreNormalizerAgent_SynchronizedWrapper(ReviewScoreNormalizerAgent)

def get_agent():
    return ReviewScoreNormalizerAgent

def get_synchronized_wrapper():
    return ReviewScoreNormalizerAgent_sync

print(f"Agent file dedicated ReviewScoreNormalizerAgent L6 Team ReviewAnalysisResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
