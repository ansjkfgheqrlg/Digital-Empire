...
"""
AGENTE DEDICATO - File singolo per ReviewResearchLeader
...
ReviewResearchLeader = Agent(
    ...
    role="Leader ReviewAnalysisResearchTeam gestisce review site discovery extraction normalization validation - L3 - Team ReviewAnalysisResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=3,
    team="ReviewAnalysisResearchTeam",
    ...
    decision_logic="""Come agente ReviewResearchLeader L3 in team ReviewAnalysisResearchTeam ecosistema ResearchEcosystem sub ReviewSub:
    Leader ReviewAnalysisResearchTeam gestisce review site discovery extraction normalization validation
    ...
    """,
    connections={"reports_to": ["ResearchEcosystemController"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_ReviewAnalysisResearchTeam"]},
...
class ReviewResearchLeader_SynchronizedWrapper:
...
ReviewResearchLeader_sync = ReviewResearchLeader_SynchronizedWrapper(ReviewResearchLeader)

def get_agent():
    return ReviewResearchLeader

def get_synchronized_wrapper():
    return ReviewResearchLeader_sync

print(f"Agent file dedicated ReviewResearchLeader L3 Team ReviewAnalysisResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
