...
"""
AGENTE DEDICATO - File singolo per WritingQualityCheckerAgent
...
WritingQualityCheckerAgent = Agent(
    ...
    role="Controlla qualita scrittura uniformita - support - L6 - Team BookWritingTeam - Ecosistema ProductionEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="BookWritingTeam",
    ecosystem="ProductionEcosystem",
    sub_ecosystem="WritingSub",
    inputs=["chapter_content"],
    outputs=["writing_quality_score"],
    decision_logic="""Come agente WritingQualityCheckerAgent L6 in team BookWritingTeam ecosistema ProductionEcosystem sub WritingSub:
    Controlla qualita scrittura uniformita - support
...
class WritingQualityCheckerAgent_SynchronizedWrapper:
...
WritingQualityCheckerAgent_sync = WritingQualityCheckerAgent_SynchronizedWrapper(WritingQualityCheckerAgent)

def get_agent():
    return WritingQualityCheckerAgent

def get_synchronized_wrapper():
    return WritingQualityCheckerAgent_sync

print(f"Agent file dedicated WritingQualityCheckerAgent L6 Team BookWritingTeam Ecosistema ProductionEcosystem - perfect synchrony harmony initialized")
