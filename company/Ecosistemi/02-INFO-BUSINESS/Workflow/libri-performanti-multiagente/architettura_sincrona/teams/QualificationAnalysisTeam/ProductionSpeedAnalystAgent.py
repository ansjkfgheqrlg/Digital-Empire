...
"""
AGENTE DEDICATO - File singolo per ProductionSpeedAnalystAgent
...
ProductionSpeedAnalystAgent = Agent(
    ...
    role="Stima tempo produzione flag too slow vs modello quantita sostenibile - senior - L4 - Team QualificationAnalysisTeam - Ecosistema QualificationEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="QualificationAnalysisTeam",
    ecosystem="QualificationEcosystem",
    sub_ecosystem="AnalysisSub",
    inputs=["book_complexity", "chapter_count"],
    outputs=["speed_estimate", "too_slow_flag"],
    decision_logic="""Come agente ProductionSpeedAnalystAgent L4 in team QualificationAnalysisTeam ecosistema QualificationEcosystem sub AnalysisSub:
    Stima tempo produzione flag too slow vs modello quantita sostenibile - senior
...
class ProductionSpeedAnalystAgent_SynchronizedWrapper:
...
ProductionSpeedAnalystAgent_sync = ProductionSpeedAnalystAgent_SynchronizedWrapper(ProductionSpeedAnalystAgent)

def get_agent():
    return ProductionSpeedAnalystAgent

def get_synchronized_wrapper():
    return ProductionSpeedAnalystAgent_sync

print(f"Agent file dedicated ProductionSpeedAnalystAgent L4 Team QualificationAnalysisTeam Ecosistema QualificationEcosystem - perfect synchrony harmony initialized")
