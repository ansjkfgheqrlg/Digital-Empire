...
# Team definition - non è più un unico file per tutti i team, ma file dedicato per ProductionReadinessTeam
# Ogni agente ha suo file dedicato sotto questa cartella e lavora in sincronia perfetta

TEAM_NAME = "ProductionReadinessTeam"
ECOSYSTEM = "PlanningEcosystem"
SUB_ECOSYSTEM = "ReadinessSub"
LEADER = "ProductionReadinessLeader"
MEMBERS = ['ProductionReadinessLeader', 'ReadinessCheckerAgent', 'ResourceEstimatorAgent', 'ProductionStartSignalAgent', 'RiskMitigationPlannerAgent']
...
TEAM_DEFINITION = Team(
    ...
    external_handoff_protocol={
        ...
        "steps": [
            "1. ProductionReadinessLeader (LEADER L3) crea handoff package structured output decisions risks checkpoint ref + harmony_status synchronized",
