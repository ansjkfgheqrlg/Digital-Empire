...
# Team definition - non è più un unico file per tutti i team, ma file dedicato per StructurePlanningTeam
# Ogni agente ha suo file dedicato sotto questa cartella e lavora in sincronia perfetta

TEAM_NAME = "StructurePlanningTeam"
ECOSYSTEM = "PlanningEcosystem"
SUB_ECOSYSTEM = "StructureSub"
LEADER = "StructurePlanningLeader"
MEMBERS = ['StructurePlanningLeader', 'VideoStructureArchitectAgent', 'ChapterDesignerAgent', 'DetailFillerAgent', 'PlanCoherenceValidatorAgent', 'VideoStructureValidatorAgent', 'OutlineOptimizerAgent', 'ContentFlowDesignerAgent']
...
TEAM_DEFINITION = Team(
    ...
    external_handoff_protocol={
        ...
        "steps": [
            "1. StructurePlanningLeader (LEADER L3) crea handoff package structured output decisions risks checkpoint ref + harmony_status synchronized",
