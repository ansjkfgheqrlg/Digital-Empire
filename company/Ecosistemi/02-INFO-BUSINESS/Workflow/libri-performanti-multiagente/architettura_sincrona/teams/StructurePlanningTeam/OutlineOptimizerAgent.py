...
"""
AGENTE DEDICATO - File singolo per OutlineOptimizerAgent
...
OutlineOptimizerAgent = Agent(
    ...
    role="Ottimizza outline capitoli flusso sostenibilita - senior - L4 - Team StructurePlanningTeam - Ecosistema PlanningEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="StructurePlanningTeam",
    ...
    decision_logic="""Come agente OutlineOptimizerAgent L4 in team StructurePlanningTeam ecosistema PlanningEcosystem sub StructureSub:
    Ottimizza outline capitoli flusso sostenibilita - senior
...
class OutlineOptimizerAgent_SynchronizedWrapper:
...
OutlineOptimizerAgent_sync = OutlineOptimizerAgent_SynchronizedWrapper(OutlineOptimizerAgent)

def get_agent():
    return OutlineOptimizerAgent

def get_synchronized_wrapper():
    return OutlineOptimizerAgent_sync

print(f"Agent file dedicated OutlineOptimizerAgent L4 Team StructurePlanningTeam Ecosistema PlanningEcosystem - perfect synchrony harmony initialized")
