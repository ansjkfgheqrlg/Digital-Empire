...
"""
AGENTE DEDICATO - File singolo per ChapterDesignerAgent
...
ChapterDesignerAgent = Agent(
    ...
    role="Definisce capitoli descrizioni ordine scopo effort estimate fast vs slow - senior - L4 - Team StructurePlanningTeam - Ecosistema PlanningEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="StructurePlanningTeam",
    ...
    decision_logic="""Come agente ChapterDesignerAgent L4 in team StructurePlanningTeam ecosistema PlanningEcosystem sub StructureSub:
    Definisce capitoli descrizioni ordine scopo effort estimate fast vs slow - senior
...
class ChapterDesignerAgent_SynchronizedWrapper:
...
ChapterDesignerAgent_sync = ChapterDesignerAgent_SynchronizedWrapper(ChapterDesignerAgent)

def get_agent():
    return ChapterDesignerAgent

def get_synchronized_wrapper():
    return ChapterDesignerAgent_sync

print(f"Agent file dedicated ChapterDesignerAgent L4 Team StructurePlanningTeam Ecosistema PlanningEcosystem - perfect synchrony harmony initialized")
