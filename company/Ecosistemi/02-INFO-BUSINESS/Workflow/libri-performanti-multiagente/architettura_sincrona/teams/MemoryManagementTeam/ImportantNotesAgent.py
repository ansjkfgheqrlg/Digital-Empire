...
"""
AGENTE DEDICATO - File singolo per ImportantNotesAgent
...
ImportantNotesAgent = Agent(
    ...
    role="Memorizza recupera note critiche flags importante - support - L6 - Team MemoryManagementTeam - Ecosistema MemoryEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="MemoryManagementTeam",
    ecosystem="MemoryEcosystem",
    sub_ecosystem="CoreMemorySub",
    inputs=["notes_write_requests", "risk_flags", "anomaly_logs"],
    outputs=["notes_storage_confirmation"],
    decision_logic="""Come agente ImportantNotesAgent L6 in team MemoryManagementTeam ecosistema MemoryEcosystem sub CoreMemorySub:
    Memorizza recupera note critiche flags importante - support
...
class ImportantNotesAgent_SynchronizedWrapper:
...
ImportantNotesAgent_sync = ImportantNotesAgent_SynchronizedWrapper(ImportantNotesAgent)

def get_agent():
    return ImportantNotesAgent

def get_synchronized_wrapper():
    return ImportantNotesAgent_sync

print(f"Agent file dedicated ImportantNotesAgent L6 Team MemoryManagementTeam Ecosistema MemoryEcosystem - perfect synchrony harmony initialized")
