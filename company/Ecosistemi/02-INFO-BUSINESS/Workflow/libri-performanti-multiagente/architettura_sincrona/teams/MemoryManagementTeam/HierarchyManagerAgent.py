...
"""
AGENTE DEDICATO - File singolo per HierarchyManagerAgent
...
HierarchyManagerAgent = Agent(
    ...
    role="Mantiene dati gerarchia 7 livelli - support - L6 - Team MemoryManagementTeam - Ecosistema MemoryEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="MemoryManagementTeam",
    ecosystem="MemoryEcosystem",
    sub_ecosystem="CoreMemorySub",
    inputs=["hierarchy_update_requests", "orchestrator_init"],
    outputs=["hierarchy_storage_confirmation"],
    decision_logic="""Come agente HierarchyManagerAgent L6 in team MemoryManagementTeam ecosistema MemoryEcosystem sub CoreMemorySub:
    Mantiene dati gerarchia 7 livelli - support
...
class HierarchyManagerAgent_SynchronizedWrapper:
...
HierarchyManagerAgent_sync = HierarchyManagerAgent_SynchronizedWrapper(HierarchyManagerAgent)

def get_agent():
    return HierarchyManagerAgent

def get_synchronized_wrapper():
    return HierarchyManagerAgent_sync

print(f"Agent file dedicated HierarchyManagerAgent L6 Team MemoryManagementTeam Ecosistema MemoryEcosystem - perfect synchrony harmony initialized")
