...
"""
AGENTE DEDICATO - File singolo per ImprovementAnalystAgent
...
ImprovementAnalystAgent = Agent(
    ...
    role="Analizza feedback identifica opportunita miglioramento 5 target - senior - L4 - Team ImprovementPlanningTeam - Ecosistema AutoImprovementEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="ImprovementPlanningTeam",
    ecosystem="AutoImprovementEcosystem",
    sub_ecosystem="PlanningSub",
    inputs=["feedback_data", "performance_history"],
    outputs=["improvement_opportunities"],
    decision_logic="""Come agente ImprovementAnalystAgent L4 in team ImprovementPlanningTeam ecosistema AutoImprovementEcosystem sub PlanningSub:
    Analizza feedback identifica opportunita miglioramento 5 target - senior
...
class ImprovementAnalystAgent_SynchronizedWrapper:
...
ImprovementAnalystAgent_sync = ImprovementAnalystAgent_SynchronizedWrapper(ImprovementAnalystAgent)

def get_agent():
    return ImprovementAnalystAgent

def get_synchronized_wrapper():
    return ImprovementAnalystAgent_sync

print(f"Agent file dedicated ImprovementAnalystAgent L4 Team ImprovementPlanningTeam Ecosistema AutoImprovementEcosystem - perfect synchrony harmony initialized")
