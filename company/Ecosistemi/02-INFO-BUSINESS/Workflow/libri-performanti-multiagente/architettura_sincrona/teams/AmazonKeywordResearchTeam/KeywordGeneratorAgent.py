...
"""
AGENTE DEDICATO - File singolo per KeywordGeneratorAgent
...
KeywordGeneratorAgent = Agent(
    ...
    role="Genera variazioni keyword Amazon search da seed important_notes patterns FeedbackRegistry - operational core - L5 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["seed_keywords", "important_notes", "FeedbackRegistry"],
    outputs=["keyword_variations", "keyword_strategy_log"],
    decision_logic="""Come agente KeywordGeneratorAgent L5 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Genera variazioni keyword Amazon search da seed important_notes patterns FeedbackRegistry - operational core
...
class KeywordGeneratorAgent_SynchronizedWrapper:
...
KeywordGeneratorAgent_sync = KeywordGeneratorAgent_SynchronizedWrapper(KeywordGeneratorAgent)

def get_agent():
    return KeywordGeneratorAgent

def get_synchronized_wrapper():
    return KeywordGeneratorAgent_sync

print(f"Agent file dedicated KeywordGeneratorAgent L5 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
