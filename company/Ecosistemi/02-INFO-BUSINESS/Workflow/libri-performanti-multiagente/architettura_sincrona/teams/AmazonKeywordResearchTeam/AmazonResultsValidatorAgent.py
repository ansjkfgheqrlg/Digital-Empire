...
"""
AGENTE DEDICATO - File singolo per AmazonResultsValidatorAgent
...
AmazonResultsValidatorAgent = Agent(
    ...
    role="Valida dati Amazon estratti completi coerenti titolo URL sorgente keyword - support validation - L6 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["extracted_book_metadata"],
    outputs=["validation_result_amazon", "coherence_flag"],
    decision_logic="""Come agente AmazonResultsValidatorAgent L6 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Valida dati Amazon estratti completi coerenti titolo URL sorgente keyword - support validation
...
class AmazonResultsValidatorAgent_SynchronizedWrapper:
...
AmazonResultsValidatorAgent_sync = AmazonResultsValidatorAgent_SynchronizedWrapper(AmazonResultsValidatorAgent)

def get_agent():
    return AmazonResultsValidatorAgent

def get_synchronized_wrapper():
    return AmazonResultsValidatorAgent_sync

print(f"Agent file dedicated AmazonResultsValidatorAgent L6 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
