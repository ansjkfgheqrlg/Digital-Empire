...
print(f"Skill dedicated file BookWritingConsistencySkill - owners {len(BookWritingConsistencySkill.owner_agents)} - trigger {'BookWritingConsistencySkill'}")
