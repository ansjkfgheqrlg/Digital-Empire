...
print(f"Skill dedicated file VideoStructureDesignSkill - owners {len(VideoStructureDesignSkill.owner_agents)} - trigger {'VideoStructureDesignSkill'}")
