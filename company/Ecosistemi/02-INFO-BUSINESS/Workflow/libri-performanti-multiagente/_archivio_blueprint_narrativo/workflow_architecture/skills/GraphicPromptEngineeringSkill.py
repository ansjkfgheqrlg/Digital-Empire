...
print(f"Skill dedicated file GraphicPromptEngineeringSkill - owners {len(GraphicPromptEngineeringSkill.owner_agents)} - trigger {'GraphicPromptEngineeringSkill'}")
