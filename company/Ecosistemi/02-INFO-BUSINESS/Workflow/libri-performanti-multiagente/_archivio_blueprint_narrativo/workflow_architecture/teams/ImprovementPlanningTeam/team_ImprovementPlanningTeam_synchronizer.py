...
# Team definition - non è più un unico file per tutti i team, ma file dedicato per ImprovementPlanningTeam
# Ogni agente ha suo file dedicato sotto questa cartella e lavora in sincronia perfetta

TEAM_NAME = "ImprovementPlanningTeam"
ECOSYSTEM = "AutoImprovementEcosystem"
SUB_ECOSYSTEM = "PlanningSub"
LEADER = "ImprovementPlanningLeader"
MEMBERS = ['ImprovementPlanningLeader', 'ImprovementAnalystAgent', 'PriorityRankerAgent', 'ImprovementPlanWriterAgent', 'OpportunityIdentifierAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Responsabilita principale ImprovementPlanningTeam in AutoImprovementEcosystem", "Gestisce flusso interno con TeamSynchronyProtocol", "Valida output con validator agent", "Crea checkpoint condiviso via CheckpointManagerAgent", "Gestisce self-healing sincronizzato intra-team", "Esegue handoff esterno 8-step sincronizzato via InterTeamHarmonyProtocol"],
    ...
    external_handoff_protocol={
        ...
        "steps": [
            "1. ImprovementPlanningLeader (LEADER L3) crea handoff package structured output decisions risks checkpoint ref + harmony_status synchronized",
