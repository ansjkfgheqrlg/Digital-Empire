...
"""
AGENTE DEDICATO - File singolo per StyleEnforcerAgent
...
StyleEnforcerAgent = Agent(
    ...
    role="Garantisce stile scrittura uniforme - senior - L4 - Team BookWritingTeam - Ecosistema ProductionEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="BookWritingTeam",
    ecosystem="ProductionEcosystem",
    sub_ecosystem="WritingSub",
    inputs=["manuscript_draft", "style_notes"],
    outputs=["style_normalized_manuscript"],
    decision_logic="""Come agente StyleEnforcerAgent L4 in team BookWritingTeam ecosistema ProductionEcosystem sub WritingSub:
    Garantisce stile scrittura uniforme - senior
...
class StyleEnforcerAgent_SynchronizedWrapper:
...
StyleEnforcerAgent_sync = StyleEnforcerAgent_SynchronizedWrapper(StyleEnforcerAgent)

def get_agent():
    return StyleEnforcerAgent

def get_synchronized_wrapper():
    return StyleEnforcerAgent_sync

print(f"Agent file dedicated StyleEnforcerAgent L4 Team BookWritingTeam Ecosistema ProductionEcosystem - perfect synchrony harmony initialized")
