...
"""
AGENTE DEDICATO - File singolo per AmazonSearchAgent
...
AmazonSearchAgent = Agent(
    ...
    role="Esegue ricerche Amazon via Playwright operational tool real navigation - operational core Playwright - L5 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["keyword_variations"],
    outputs=["search_results_raw", "search_metadata"],
    decision_logic="""Come agente AmazonSearchAgent L5 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Esegue ricerche Amazon via Playwright operational tool real navigation - operational core Playwright
...
class AmazonSearchAgent_SynchronizedWrapper:
...
AmazonSearchAgent_sync = AmazonSearchAgent_SynchronizedWrapper(AmazonSearchAgent)

def get_agent():
    return AmazonSearchAgent

def get_synchronized_wrapper():
    return AmazonSearchAgent_sync

print(f"Agent file dedicated AmazonSearchAgent L5 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
