...
"""
AGENTE DEDICATO - File singolo per OutputMonitorAgent
Team: DetectionTeam
...
OutputMonitorAgent = Agent(
    ...
    role="Monitora output phase completeness coherence - Detection Team senior - L4 - Team DetectionTeam - Ecosistema SelfHealingEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="DetectionTeam",
    ...
    decision_logic="""Come agente OutputMonitorAgent L4 in team DetectionTeam ecosistema SelfHealingEcosystem sub DetectionSub:
    Monitora output phase completeness coherence - Detection Team senior
...
class OutputMonitorAgent_SynchronizedWrapper:
...
OutputMonitorAgent_sync = OutputMonitorAgent_SynchronizedWrapper(OutputMonitorAgent)

def get_agent():
    return OutputMonitorAgent

def get_synchronized_wrapper():
    return OutputMonitorAgent_sync

print(f"Agent file dedicated OutputMonitorAgent L4 Team DetectionTeam Ecosistema SelfHealingEcosystem - perfect synchrony harmony initialized")
