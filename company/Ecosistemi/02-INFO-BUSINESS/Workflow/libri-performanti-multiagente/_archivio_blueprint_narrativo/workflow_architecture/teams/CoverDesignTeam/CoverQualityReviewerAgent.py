...
"""
AGENTE DEDICATO - File singolo per CoverQualityReviewerAgent
...
CoverQualityReviewerAgent = Agent(
    ...
    role="Revisiona qualita cover critica pass fail non skippabile - support - L6 - Team CoverDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="CoverDesignTeam",
    ecosystem="VisualEcosystem",
    sub_ecosystem="CoverSub",
    inputs=["cover_generated_raw", "cover_concept"],
    outputs=["cover_quality_score", "cover_pass_fail"],
    decision_logic="""Come agente CoverQualityReviewerAgent L6 in team CoverDesignTeam ecosistema VisualEcosystem sub CoverSub:
    Revisiona qualita cover critica pass fail non skippabile - support
...
class CoverQualityReviewerAgent_SynchronizedWrapper:
...
CoverQualityReviewerAgent_sync = CoverQualityReviewerAgent_SynchronizedWrapper(CoverQualityReviewerAgent)

def get_agent():
    return CoverQualityReviewerAgent

def get_synchronized_wrapper():
    return CoverQualityReviewerAgent_sync

print(f"Agent file dedicated CoverQualityReviewerAgent L6 Team CoverDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
