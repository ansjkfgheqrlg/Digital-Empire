...
KeywordExpansionLeader = Agent(
    ...
    role="Leader KeywordExpansionTeam espansione keyword quando empty result LearningLog - espansione - L3 Team KeywordExpansionTeam Ecosistema ResearchEcosystem - perfetta sincronia armonia",
    hierarchy_level=3,
    ...
    playwright_usage="real operational tool" if "Playwright" in "KeywordExpansionLeader" or "Search" in "KeywordExpansionLeader" or "Extractor" in "KeywordExpansionLeader" else None,
    skill_usage=["SelfHealingSkill","MemoryReadWriteSkill","CheckpointManagementSkill"],
    level_name="L3"
)

class KeywordExpansionLeader_SynchronizedWrapper:
...
KeywordExpansionLeader_sync = KeywordExpansionLeader_SynchronizedWrapper(KeywordExpansionLeader)
def get_agent():
    return KeywordExpansionLeader
def get_synchronized_wrapper():
    return KeywordExpansionLeader_sync
print(f"Agent dedicated KeywordExpansionLeader L3 Team KeywordExpansionTeam - perfect synchrony harmony")
