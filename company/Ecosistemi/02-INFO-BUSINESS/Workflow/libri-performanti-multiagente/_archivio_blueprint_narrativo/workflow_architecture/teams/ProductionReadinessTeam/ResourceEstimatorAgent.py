...
"""
AGENTE DEDICATO - File singolo per ResourceEstimatorAgent
...
ResourceEstimatorAgent = Agent(
    ...
    role="Stima risorse necessarie tempo capitoli grafica cover - operational - L5 - Team ProductionReadinessTeam - Ecosistema PlanningEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="ProductionReadinessTeam",
    ecosystem="PlanningEcosystem",
    sub_ecosystem="ReadinessSub",
    inputs=["second_level_plan", "chapter_list", "graphic_needs"],
    outputs=["resource_estimate", "sustainability_assessment"],
    decision_logic="""Come agente ResourceEstimatorAgent L5 in team ProductionReadinessTeam ecosistema PlanningEcosystem sub ReadinessSub:
    Stima risorse necessarie tempo capitoli grafica cover - operational
...
class ResourceEstimatorAgent_SynchronizedWrapper:
...
ResourceEstimatorAgent_sync = ResourceEstimatorAgent_SynchronizedWrapper(ResourceEstimatorAgent)

def get_agent():
    return ResourceEstimatorAgent

def get_synchronized_wrapper():
    return ResourceEstimatorAgent_sync

print(f"Agent file dedicated ResourceEstimatorAgent L5 Team ProductionReadinessTeam Ecosistema PlanningEcosystem - perfect synchrony harmony initialized")
