...
"""
AGENTE DEDICATO - File singolo per GraphicGeneratorAgent
...
GraphicGeneratorAgent = Agent(
    ...
    role="Genera grafiche using prompt salva via VisualPlaywrightSaveAgent visual_save - operational Playwright - L5 - Team GraphicDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="GraphicDesignTeam",
    ...
    decision_logic="""Come agente GraphicGeneratorAgent L5 in team GraphicDesignTeam ecosistema VisualEcosystem sub GraphicSub:
    Genera grafiche using prompt salva via VisualPlaywrightSaveAgent visual_save - operational Playwright
...
class GraphicGeneratorAgent_SynchronizedWrapper:
...
GraphicGeneratorAgent_sync = GraphicGeneratorAgent_SynchronizedWrapper(GraphicGeneratorAgent)

def get_agent():
    return GraphicGeneratorAgent

def get_synchronized_wrapper():
    return GraphicGeneratorAgent_sync

print(f"Agent file dedicated GraphicGeneratorAgent L5 Team GraphicDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
