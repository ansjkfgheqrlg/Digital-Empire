...
"""
AGENTE DEDICATO - File singolo per CoverPromptCreatorAgent
...
CoverPromptCreatorAgent = Agent(
    ...
    role="Crea prompt dettagliato cover generation - operational - L5 - Team CoverDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="CoverDesignTeam",
    ecosystem="VisualEcosystem",
    sub_ecosystem="CoverSub",
    inputs=["cover_concept", "manuscript"],
    outputs=["cover_prompt_detailed"],
    decision_logic="""Come agente CoverPromptCreatorAgent L5 in team CoverDesignTeam ecosistema VisualEcosystem sub CoverSub:
    Crea prompt dettagliato cover generation - operational
...
class CoverPromptCreatorAgent_SynchronizedWrapper:
...
CoverPromptCreatorAgent_sync = CoverPromptCreatorAgent_SynchronizedWrapper(CoverPromptCreatorAgent)

def get_agent():
    return CoverPromptCreatorAgent

def get_synchronized_wrapper():
    return CoverPromptCreatorAgent_sync

print(f"Agent file dedicated CoverPromptCreatorAgent L5 Team CoverDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
