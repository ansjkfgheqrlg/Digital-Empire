...
"""
AGENTE DEDICATO - File singolo per OutcomeCollectorAgent
...
OutcomeCollectorAgent = Agent(
    ...
    role="Raccoglie outcomes da cicli completati per auto-improvement - operational - L5 - Team FeedbackCollectionTeam - Ecosistema AutoImprovementEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="FeedbackCollectionTeam",
    ecosystem="AutoImprovementEcosystem",
    sub_ecosystem="FeedbackSub",
    inputs=["cycle_completion_signals", "phase_completion_logs"],
    outputs=["collected_outcomes"],
    decision_logic="""Come agente OutcomeCollectorAgent L5 in team FeedbackCollectionTeam ecosistema AutoImprovementEcosystem sub FeedbackSub:
    Raccoglie outcomes da cicli completati per auto-improvement - operational
...
class OutcomeCollectorAgent_SynchronizedWrapper:
...
OutcomeCollectorAgent_sync = OutcomeCollectorAgent_SynchronizedWrapper(OutcomeCollectorAgent)

def get_agent():
    return OutcomeCollectorAgent

def get_synchronized_wrapper():
    return OutcomeCollectorAgent_sync

print(f"Agent file dedicated OutcomeCollectorAgent L5 Team FeedbackCollectionTeam Ecosistema AutoImprovementEcosystem - perfect synchrony harmony initialized")
