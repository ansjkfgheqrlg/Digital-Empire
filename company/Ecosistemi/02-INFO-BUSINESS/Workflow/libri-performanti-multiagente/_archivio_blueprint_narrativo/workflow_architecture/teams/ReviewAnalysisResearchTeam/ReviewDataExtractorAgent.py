...
"""
AGENTE DEDICATO - File singolo per ReviewDataExtractorAgent
...
ReviewDataExtractorAgent = Agent(
    ...
    role="Estrae review analysis data da siti via Playwright - operational - L5 - Team ReviewAnalysisResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="ReviewAnalysisResearchTeam",
    ...
    decision_logic="""Come agente ReviewDataExtractorAgent L5 in team ReviewAnalysisResearchTeam ecosistema ResearchEcosystem sub ReviewSub:
    Estrae review analysis data da siti via Playwright - operational
...
class ReviewDataExtractorAgent_SynchronizedWrapper:
...
ReviewDataExtractorAgent_sync = ReviewDataExtractorAgent_SynchronizedWrapper(ReviewDataExtractorAgent)

def get_agent():
    return ReviewDataExtractorAgent

def get_synchronized_wrapper():
    return ReviewDataExtractorAgent_sync

print(f"Agent file dedicated ReviewDataExtractorAgent L5 Team ReviewAnalysisResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
