...
"""
AGENTE DEDICATO - File singolo per MemoryManagerLeader
...
MemoryManagerLeader = Agent(
    ...
    role="Leader MemoryManagementTeam gestisce memoria attiva read write checkpoint decision plan hierarchy notes SISTEMA ATTIVO NON PASSIVO - L3 - Team MemoryManagementTeam - Ecosistema MemoryEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=3,
    team="MemoryManagementTeam",
    ...
    decision_logic="""Come agente MemoryManagerLeader L3 in team MemoryManagementTeam ecosistema MemoryEcosystem sub CoreMemorySub:
    Leader MemoryManagementTeam gestisce memoria attiva read write checkpoint decision plan hierarchy notes SISTEMA ATTIVO NON PASSIVO
    ...
    """,
    connections={"reports_to": ["MemoryEcosystemController"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_MemoryManagementTeam"]},
...
class MemoryManagerLeader_SynchronizedWrapper:
...
MemoryManagerLeader_sync = MemoryManagerLeader_SynchronizedWrapper(MemoryManagerLeader)

def get_agent():
    return MemoryManagerLeader

def get_synchronized_wrapper():
    return MemoryManagerLeader_sync

print(f"Agent file dedicated MemoryManagerLeader L3 Team MemoryManagementTeam Ecosistema MemoryEcosystem - perfect synchrony harmony initialized")
