...
TEAM_NAME = "ContentPlanningTeam"
ECOSYSTEM = "PlanningEcosystem"
SUB_ECOSYSTEM = "ContentSub"
LEADER = "ContentPlanningLeader"
MEMBERS = ['ContentPlanningLeader', 'ContentDetailArchitectAgent', 'ContentFlowDesignerAgent', 'ResourceAllocationPlannerAgent', 'ContentDetailArchitectAgent2']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Team ContentPlanningTeam in PlanningEcosystem - perfetta sincronia armonia", "Gestisce flusso interno con TeamSynchronyProtocol", "Checkpoint condiviso", "Self-healing sincronizzato", "Handoff esterno 8-step"],
    input_source="Handoff package + memory PlanningEcosystem + sync signals",
