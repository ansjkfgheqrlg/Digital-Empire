...
"""
AGENTE DEDICATO - File singolo per DecisionQualityCheckerAgent
...
DecisionQualityCheckerAgent = Agent(
    ...
    role="Verifica qualita decisione traceability motivazione - operational - L5 - Team QualificationDecisionTeam - Ecosistema QualificationEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="QualificationDecisionTeam",
    ecosystem="QualificationEcosystem",
    sub_ecosystem="DecisionSub",
    inputs=["final_report_draft"],
    outputs=["decision_quality_validation"],
    decision_logic="""Come agente DecisionQualityCheckerAgent L5 in team QualificationDecisionTeam ecosistema QualificationEcosystem sub DecisionSub:
    Verifica qualita decisione traceability motivazione - operational
...
class DecisionQualityCheckerAgent_SynchronizedWrapper:
...
DecisionQualityCheckerAgent_sync = DecisionQualityCheckerAgent_SynchronizedWrapper(DecisionQualityCheckerAgent)

def get_agent():
    return DecisionQualityCheckerAgent

def get_synchronized_wrapper():
    return DecisionQualityCheckerAgent_sync

print(f"Agent file dedicated DecisionQualityCheckerAgent L5 Team QualificationDecisionTeam Ecosistema QualificationEcosystem - perfect synchrony harmony initialized")
