...
"""
AGENTE DEDICATO - File singolo per AmazonDataExtractorAgent
...
AmazonDataExtractorAgent = Agent(
    ...
    role="Estrae dati libri titoli autori ratings prezzi categorie via Playwright capture - operational - L5 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["search_results_raw"],
    outputs=["extracted_book_metadata", "extraction_log"],
    decision_logic="""Come agente AmazonDataExtractorAgent L5 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Estrae dati libri titoli autori ratings prezzi categorie via Playwright capture - operational
...
class AmazonDataExtractorAgent_SynchronizedWrapper:
...
AmazonDataExtractorAgent_sync = AmazonDataExtractorAgent_SynchronizedWrapper(AmazonDataExtractorAgent)

def get_agent():
    return AmazonDataExtractorAgent

def get_synchronized_wrapper():
    return AmazonDataExtractorAgent_sync

print(f"Agent file dedicated AmazonDataExtractorAgent L5 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
