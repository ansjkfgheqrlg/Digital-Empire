...
"""
AGENTE DEDICATO - File singolo per ReviewDataCaptureAgent
...
ReviewDataCaptureAgent = Agent(
    ...
    role="Atomic capture review analysis data singola site - micro - L7 - Team ReviewAnalysisResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=7,
    team="ReviewAnalysisResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="ReviewSub",
    inputs=["extraction_request_review", "url"],
    outputs=["captured_review_data"],
    decision_logic="""Come agente ReviewDataCaptureAgent L7 in team ReviewAnalysisResearchTeam ecosistema ResearchEcosystem sub ReviewSub:
    Atomic capture review analysis data singola site - micro
...
class ReviewDataCaptureAgent_SynchronizedWrapper:
...
ReviewDataCaptureAgent_sync = ReviewDataCaptureAgent_SynchronizedWrapper(ReviewDataCaptureAgent)

def get_agent():
    return ReviewDataCaptureAgent

def get_synchronized_wrapper():
    return ReviewDataCaptureAgent_sync

print(f"Agent file dedicated ReviewDataCaptureAgent L7 Team ReviewAnalysisResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
