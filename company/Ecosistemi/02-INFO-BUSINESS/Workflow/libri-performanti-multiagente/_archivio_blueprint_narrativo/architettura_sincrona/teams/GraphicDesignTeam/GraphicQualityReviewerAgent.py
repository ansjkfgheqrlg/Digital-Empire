...
"""
AGENTE DEDICATO - File singolo per GraphicQualityReviewerAgent
...
GraphicQualityReviewerAgent = Agent(
    ...
    role="Revisiona qualita grafiche generate score pass fail loop revisione - support - L6 - Team GraphicDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="GraphicDesignTeam",
    ecosystem="VisualEcosystem",
    sub_ecosystem="GraphicSub",
    inputs=["generated_graphics_raw"],
    outputs=["quality_score_graphics", "pass_fail_flag"],
    decision_logic="""Come agente GraphicQualityReviewerAgent L6 in team GraphicDesignTeam ecosistema VisualEcosystem sub GraphicSub:
    Revisiona qualita grafiche generate score pass fail loop revisione - support
...
class GraphicQualityReviewerAgent_SynchronizedWrapper:
...
GraphicQualityReviewerAgent_sync = GraphicQualityReviewerAgent_SynchronizedWrapper(GraphicQualityReviewerAgent)

def get_agent():
    return GraphicQualityReviewerAgent

def get_synchronized_wrapper():
    return GraphicQualityReviewerAgent_sync

print(f"Agent file dedicated GraphicQualityReviewerAgent L6 Team GraphicDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
