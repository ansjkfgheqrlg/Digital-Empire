...
"""
AGENTE DEDICATO - File singolo per SustainabilityAnalystAgent
...
SustainabilityAnalystAgent = Agent(
    ...
    role="Analizza sostenibilita produzione lungo termine quantita - senior - L4 - Team QualificationAnalysisTeam - Ecosistema QualificationEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=4,
    team="QualificationAnalysisTeam",
    ecosystem="QualificationEcosystem",
    sub_ecosystem="AnalysisSub",
    inputs=["book_complexity", "resource_estimate"],
    outputs=["sustainability_score"],
    decision_logic="""Come agente SustainabilityAnalystAgent L4 in team QualificationAnalysisTeam ecosistema QualificationEcosystem sub AnalysisSub:
    Analizza sostenibilita produzione lungo termine quantita - senior
...
class SustainabilityAnalystAgent_SynchronizedWrapper:
...
SustainabilityAnalystAgent_sync = SustainabilityAnalystAgent_SynchronizedWrapper(SustainabilityAnalystAgent)

def get_agent():
    return SustainabilityAnalystAgent

def get_synchronized_wrapper():
    return SustainabilityAnalystAgent_sync

print(f"Agent file dedicated SustainabilityAnalystAgent L4 Team QualificationAnalysisTeam Ecosistema QualificationEcosystem - perfect synchrony harmony initialized")
