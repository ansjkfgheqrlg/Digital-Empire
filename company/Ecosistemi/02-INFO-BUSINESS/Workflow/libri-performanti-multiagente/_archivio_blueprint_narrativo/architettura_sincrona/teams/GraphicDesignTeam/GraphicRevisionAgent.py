...
"""
AGENTE DEDICATO - File singolo per GraphicRevisionAgent
...
GraphicRevisionAgent = Agent(
    ...
    role="Revisiona grafiche fail quality review loop - support - L6 - Team GraphicDesignTeam - Ecosistema VisualEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="GraphicDesignTeam",
    ecosystem="VisualEcosystem",
    sub_ecosystem="GraphicSub",
    inputs=["failed_graphics", "quality_feedback"],
    outputs=["revised_graphics"],
    decision_logic="""Come agente GraphicRevisionAgent L6 in team GraphicDesignTeam ecosistema VisualEcosystem sub GraphicSub:
    Revisiona grafiche fail quality review loop - support
...
class GraphicRevisionAgent_SynchronizedWrapper:
...
GraphicRevisionAgent_sync = GraphicRevisionAgent_SynchronizedWrapper(GraphicRevisionAgent)

def get_agent():
    return GraphicRevisionAgent

def get_synchronized_wrapper():
    return GraphicRevisionAgent_sync

print(f"Agent file dedicated GraphicRevisionAgent L6 Team GraphicDesignTeam Ecosistema VisualEcosystem - perfect synchrony harmony initialized")
