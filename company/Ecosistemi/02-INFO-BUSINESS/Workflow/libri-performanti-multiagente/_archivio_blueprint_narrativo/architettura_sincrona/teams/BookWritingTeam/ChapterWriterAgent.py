...
"""
AGENTE DEDICATO - File singolo per ChapterWriterAgent
...
ChapterWriterAgent = Agent(
    ...
    role="Scrive capitoli singoli multiple instances parallele legge memoria continuity - operational core - L5 - Team BookWritingTeam - Ecosistema ProductionEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=5,
    team="BookWritingTeam",
    ecosystem="ProductionEcosystem",
    sub_ecosystem="WritingSub",
    inputs=["chapter_definition", "second_level_plan", "memory_context"],
    outputs=["chapter_written_content", "chapter_production_log"],
    decision_logic="""Come agente ChapterWriterAgent L5 in team BookWritingTeam ecosistema ProductionEcosystem sub WritingSub:
    Scrive capitoli singoli multiple instances parallele legge memoria continuity - operational core
...
class ChapterWriterAgent_SynchronizedWrapper:
...
ChapterWriterAgent_sync = ChapterWriterAgent_SynchronizedWrapper(ChapterWriterAgent)

def get_agent():
    return ChapterWriterAgent

def get_synchronized_wrapper():
    return ChapterWriterAgent_sync

print(f"Agent file dedicated ChapterWriterAgent L5 Team BookWritingTeam Ecosistema ProductionEcosystem - perfect synchrony harmony initialized")
