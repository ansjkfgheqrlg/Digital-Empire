...
"""
AGENTE DEDICATO - File singolo per ReviewSiteNavigatorAgent
...
ReviewSiteNavigatorAgent = Agent(
    ...
    role="Atomic navigator per review analysis sites - micro - L7 - Team ReviewAnalysisResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=7,
    team="ReviewAnalysisResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="ReviewSub",
    inputs=["navigation_request_review_site"],
    outputs=["navigation_result_review"],
    decision_logic="""Come agente ReviewSiteNavigatorAgent L7 in team ReviewAnalysisResearchTeam ecosistema ResearchEcosystem sub ReviewSub:
    Atomic navigator per review analysis sites - micro
...
class ReviewSiteNavigatorAgent_SynchronizedWrapper:
...
ReviewSiteNavigatorAgent_sync = ReviewSiteNavigatorAgent_SynchronizedWrapper(ReviewSiteNavigatorAgent)

def get_agent():
    return ReviewSiteNavigatorAgent

def get_synchronized_wrapper():
    return ReviewSiteNavigatorAgent_sync

print(f"Agent file dedicated ReviewSiteNavigatorAgent L7 Team ReviewAnalysisResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
