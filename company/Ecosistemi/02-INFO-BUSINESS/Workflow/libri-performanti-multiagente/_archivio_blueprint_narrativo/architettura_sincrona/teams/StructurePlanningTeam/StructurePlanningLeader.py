...
"""
AGENTE DEDICATO - File singolo per StructurePlanningLeader
...
StructurePlanningLeader = Agent(
    ...
    role="Leader StructurePlanningTeam gestisce video_structure REQUIRED preservato verbatim chapters details coherence CONTROL POINT CRITICO - L3 - Team StructurePlanningTeam - Ecosistema PlanningEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=3,
    team="StructurePlanningTeam",
    ...
    decision_logic="""Come agente StructurePlanningLeader L3 in team StructurePlanningTeam ecosistema PlanningEcosystem sub StructureSub:
    Leader StructurePlanningTeam gestisce video_structure REQUIRED preservato verbatim chapters details coherence CONTROL POINT CRITICO
    ...
    """,
    connections={"reports_to": ["PlanningEcosystemController"], "manages": [], "collaborates_with": ["MemoryManagerLeader","MemoryReaderAgent","CheckpointManagerAgent","TeamSynchronizer_StructurePlanningTeam"]},
...
class StructurePlanningLeader_SynchronizedWrapper:
...
StructurePlanningLeader_sync = StructurePlanningLeader_SynchronizedWrapper(StructurePlanningLeader)

def get_agent():
    return StructurePlanningLeader

def get_synchronized_wrapper():
    return StructurePlanningLeader_sync

print(f"Agent file dedicated StructurePlanningLeader L3 Team StructurePlanningTeam Ecosistema PlanningEcosystem - perfect synchrony harmony initialized")
