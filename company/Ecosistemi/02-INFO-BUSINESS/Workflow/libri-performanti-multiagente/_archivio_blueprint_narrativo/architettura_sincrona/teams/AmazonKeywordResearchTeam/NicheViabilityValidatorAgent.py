...
"""
AGENTE DEDICATO - File singolo per NicheViabilityValidatorAgent
...
NicheViabilityValidatorAgent = Agent(
    ...
    role="Valida fattibilita nicchia da BookNicheDecisionSkill - support - L6 - Team AmazonKeywordResearchTeam - Ecosistema ResearchEcosystem - Lavora in perfetta sincronia e armonia con altri agenti via TeamSynchronyProtocol HarmonySignal",
    hierarchy_level=6,
    team="AmazonKeywordResearchTeam",
    ecosystem="ResearchEcosystem",
    sub_ecosystem="PlaywrightOps",
    inputs=["book_opportunities", "scores"],
    outputs=["viability_validation", "viability_flag"],
    decision_logic="""Come agente NicheViabilityValidatorAgent L6 in team AmazonKeywordResearchTeam ecosistema ResearchEcosystem sub PlaywrightOps:
    Valida fattibilita nicchia da BookNicheDecisionSkill - support
...
class NicheViabilityValidatorAgent_SynchronizedWrapper:
...
NicheViabilityValidatorAgent_sync = NicheViabilityValidatorAgent_SynchronizedWrapper(NicheViabilityValidatorAgent)

def get_agent():
    return NicheViabilityValidatorAgent

def get_synchronized_wrapper():
    return NicheViabilityValidatorAgent_sync

print(f"Agent file dedicated NicheViabilityValidatorAgent L6 Team AmazonKeywordResearchTeam Ecosistema ResearchEcosystem - perfect synchrony harmony initialized")
