...
TEAM_NAME = "DecisionLogSubEcosystem"
ECOSYSTEM = "MemoryEcosystem"
SUB_ECOSYSTEM = "DecisionSub"
LEADER = "DecisionLogSubLeader"
MEMBERS = ['DecisionLogSubLeader', 'DecisionLogWriterAgent', 'DecisionLogReaderAgent', 'DecisionTraceabilityAgent', 'DecisionLogMicroAgent']
...
TEAM_DEFINITION = Team(
    ...
    responsibilities=["Team DecisionLogSubEcosystem in MemoryEcosystem - perfetta sincronia armonia", "Gestisce flusso interno con TeamSynchronyProtocol", "Checkpoint condiviso", "Self-healing sincronizzato", "Handoff esterno 8-step"],
