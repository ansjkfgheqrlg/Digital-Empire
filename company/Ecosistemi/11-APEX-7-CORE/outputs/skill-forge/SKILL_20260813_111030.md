...
# OBIETTIVO
Trasformare appunti grezzi in sistema operativo ad alto ROI. Input: SKILL-FORGE: Sistema che prende transcript call concessionari, estrae il dolore dei lead non risposti e genera sequenza 

# TRIGGER
Questa skill si attiva quando:
- L'utente menziona parole chiave: custom-skill, skill, forge, sistema, prende, transcript
