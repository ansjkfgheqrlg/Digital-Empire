...
| **Reparto FORGE-AGENT-SKILL** (officina agenti & skill: 4 agenti fas-*, WF-AGENT/SKILL-NEW, `TOPOLOGY.md` pubblica) | 06b-FORGE (L2.1/L2.2) | fas-qa-gate + METHOD-GUARD | ADR-009 (2026-07-20) | ADR-001/002/006/008 |
| **ASK-PROTOCOL** (`FORGE-AGENT-SKILL/workflows/ASK-PROTOCOL.md`: ASK formale obbligatorio nei FORGE-PLAN, max 3 domande mirate con raccomandazione+default) | FORGE-AGENT-SKILL (fas-conductor) | fas-qa-gate (checklist p.7) + METHOD-GUARD | MIR-3 dossier 18 (2026-07-20, CP-20260720-009) | ADR-002/005/006/008 |
| **TOPOLOGY-TEMPLATE + R2-bis** (`FORGE-AGENT-SKILL/templates/TOPOLOGY-TEMPLATE.md` + `TOPOLOGY.md` reparto: topology.md obbligatorio per ogni team ≥2 agenti forgiati, 1 pagina puntatori, no agenti fantasma) | FORGE-AGENT-SKILL (fas-conductor) | fas-qa-gate (checklist p.1) + METHOD-GUARD | MIR-9 dossier 18 (2026-07-20, CP-20260720-013) | ADR-001/002/006/008 |
| **Toolchain VS Code** (`.vscode/` condiviso + dossier `PIANO-MAESTRO/19-TOOLCHAIN-VSCODE.md`; Tier 1-3, agente = Claude Code unico) | 06b-FORGE / L2.4 ECOSYSTEM-WORKS | METHOD-GUARD + 5-bis campionario | ordine Max 2026-07-20 (CP-20260720-008) | ADR-002/003/006/008 (niente format-on-save, niente tool orfani) |
| **Skill `/youtube-lead-machine`** (`.claude/skills/youtube-lead-machine/`: kernel+6 references+evals+failure-modes) | FORGE-AGENT-SKILL (sotto 06b-FORGE) — in deploy per 04-MARKETING W7 | fas-qa-gate (verbale GATE 2026-07-20 PASS 7/7) | MIR-11 dossier 18 → WF-SKILL-NEW da `Formazzione/Youtube/` (CP-20260719-009/-004) | ADR-002/003/006/008/009 · R1-R4 · confine dossier 16 S5 |
| **carousel-factory** (brands: mentalita-brutale, …) | 03-CONTENT-FACTORY / CF-R5 | CF-R6 QA & Gate | pre-Impero, wrappato | Art.2 |
| **Sito istituzionale DE** (`Agency page - Copia/` evoluta [blog, CPB, AI area] + `Agency page/` legacy da deprecare — raccomandazione MIR-12) | 04-MARKETING (vitrina) / dep.: grafica-deploy Max | A8 copy review (MIR-12) + deploy Max | pre-Impero (Google AI Studio), wrappato | Art.2 (prove non promesse) · ADR-003 |
| **Review APSOC Sito (MIR-12)** (`Agency page - Copia/COPY-REVIEW-APSOC-SITO.md`: 78/100, 5 P0 verità/tracking/GDPR/form/offerta + ASK Q1-Q3 per Max) | 04-MARKETING / L2-1 Copywriting | copy-workflow (APSOC/CPB) + METHOD-GUARD | MIR-12 dossier 18 (2026-07-20, CP-20260720-012) vs canone MKD-brand-offer | ADR-002/003/008/009 · Art.2 |
| **Skill CRO YouTube Script Factory** (`SKILL & Agenti/SKILL/Skill CRO - Youtube - Lead magnet/`: kernel md intoccato ADR-003 + satelliti spec/tools/playbook/evals/failure-modes/memory + 3 tool python estratti) | 04-MARKETING / W7 YouTube Lead Machine | fas-qa-gate (verbale GATE retro PASS 7/7, 2026-07-20) + scoring interno 45pt | pre-Impero (Max) → retrofit MIR-5 sprint 1 (CP-20260720-014); era orfana ADR-008 | ADR-002/003/008 · delega da /youtube-lead-machine, QA copy → /copywriting |
| **Skill CRO Ricerca — Client Research Engine** (`SKILL & Agenti/SKILL/Skill CRO - Ricerca/`: master SKILL.md 1.625r + 7 knowledge reali intoccati ADR-003 + wrap satelliti spec/tools/playbook/evals/failure-modes/memory) | 01-AGENCY / Acquisizione (uso anche 04-MARKETING W7) | fas-qa-gate (verbale GATE retro PASS 7/7, 2026-07-20) | pre-Impero (Max) → retrofit MIR-5 sprint 2 (CP-20260720-015); già censita, non orfana · debito D1 manifest fantasma dichiarato | ADR-002/003/008 · tools: [] by design · valle → CRO Copy Architect |
| **LEAD-MAGNET-02 Checklist CRO 21 Punti** (`Formazzione/Youtube/LEAD-MAGNET-02-checklist-cro-21-punti.md`: magnet TOFU un-gated, ponte → Analisi Gratuita; kit W7) | 04-MARKETING / L2-1 Copywriting | copy-workflow (review APSOC PASS 93/100 in COPY-REVIEW-APSOC) + METHOD-GUARD uso commerciale | build sessione Claude 2026-07-20 (CP-20260720-010) da MKD-brand-offer + strategia + Hormozi | ADR-002/003/008/009 · Art.2 (no invenzioni) |
| **MKD Brand-Offer DE** (`FORGE-AGENT-SKILL/memory/mkd/MKD-brand-offer-DE.md`: base canonica offerta/ICP/USP/TOV/compliance da `Materiale Agency - Diglital Empire.txt`) | 04-MARKETING/L2-1 (uso: A8-Closing, copy-workflow, youtube-lead-machine) | METHOD-GUARD + A8 review per l'uso commerciale | MIR-2 dossier 18 (/forge 2026-07-20, atomi mappati + ➕ marcati) | ADR-002/003/008 · R1 mai-riassunti |
