...
## Checkpoint
- [CP-20260720-004](checkpoints/CP-20260720-004.md) — **Mentalità Brutale MB-OS foundations**: 41 file + skill FORGE 5 file; Meta API v25.0 OAuth/publish/Insights, 5 gate, queue/idempotenza/staging PNG→JPEG/kill switch, 11 reparti, strategia 28d; 14/14 test PASS. Stato SHADOW onesto: OAuth/staging/canary live pendenti. Password hard-coded correnti rimosse; B-009 rotazione obbligatoria — Arena
