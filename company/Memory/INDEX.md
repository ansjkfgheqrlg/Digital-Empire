...
- [CP-20260720-004](checkpoints/CP-20260720-004.md) — **YOUTUBE LEAD MACHINE: kit di lancio COMPLETO** (scheda Cliente d'Oro, SETUP-CANALE copy pronta, lead magnet "Analisi Gratuita" + 5 messaggi speed-to-lead, batch #1 con 6 script hook/scaletta/CTA + 2 concept copertina) — sessione Claude *(era -001, rinumerato per collisione col pivot Aureus)*
...
- [CP-20260720-001](checkpoints/CP-20260720-001.md) — **EMPIRE DESK: PIVOT AUREUS Agency OS** (Max boccia UI launcher v0.1/v2 → base nuova = piattaforma di Max in `EmpireDesk/platform/`; U0 import+build fatto, U0b offline-capable: Tailwind+Inter vendorizzati; Max=grafica intoccabile, Gael=tutto il resto) — Max via Claude
