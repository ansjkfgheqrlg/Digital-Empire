...
- **✅ G2-batch-caroselli COMPLETATO (2026-07-20):** 7 JSON caroselli creati in
  `Workfolw crea caroselli à/carousel-factory/input/` — temi empire-building/mindset
  (5 errori, lavorare di più, sistema 10k, verità freelance, framework impero, 3 scuse,
  4orevs12ore), brand `mentalita-brutale`, 7-8 slide ciascuno, caption + note_design
  incluse. Per renderizzare: `node generate.js <file.json>` (richiede Node + Puppeteer).
- **✅ G1-audit-asset COMPLETATO (2026-07-20):** `AUDIT-PAGINE-20260720.md` in
  `company/Ecosistemi/05-MULTI-BUSINESS/`. Censite 8 pagine/canali: Agency Empire (Vercel),
  CCM Premium/4varianti (Netlify), Mentalità Brutale IG (@mentalita.brutale + carousel-factory),
  Crea il tuo impero, Mentalità Business, LinkedIn outreach, Email outreach (300/gg NVIDIA Nemotron).
  5 domande aperte per Max (decisioni CCM, posizionamento, stato IG/LinkedIn). Taskboard aggiornato.
  **Prossimo: g2-funnel-manuale** (richiede prezzo da B-003 chiuso da Max — bloccante).
