...
| 3 | PLAN→ASK→BUILD→CRITIQUE→ITERATE | ⚠️ parziale (9-passi c'è, ma l'ASK è informale) | MIR-3: nei FORGE-PLAN di FORGE-AGENT-SKILL l'ASK è obbligatorio (max 3 domande mirate) |
