...
| 5 | 7 file canonici per agente | 🚧 in corso: sprint 1 ✅ youtube-script-factory · sprint 2 ✅ skill-cro-ricerca/Client Research Engine (2026-07-20, GATE retro 7/7 ×2) | MIR-5: via FORGE-AGENT-SKILL, retrofit progressivo (1 reparto-figlio per sprint) — backorder, nessuna fretta (ADR-003) |
...
| MIR-5 | Retrofit 7-file su reparti pre-impero, 1 figlio/sprint | FORGE-AGENT-SKILL | fas-qa-gate | P3 — 🚧 CAMPAGNA · ✅ SPRINT 1 (2026-07-20): `youtube-script-factory` wrap + tools estratti (GATE 7/7, CP-20260720-014) · ✅ SPRINT 2 (2026-07-20): `skill-cro-ricerca`/Client Research Engine wrap; scoperta manifest fantasma → D1 dichiarato (GATE 7/7, CP-20260720-015) · sprint 3: candidato CRO Copy Architect knowledge dir |
